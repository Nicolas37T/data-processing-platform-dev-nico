...
doc_md = """## 🚚 DAG Migración: M_BO_000000017
...
| **📄 Sub-reporte(s)** | Bolivia: Producción de Cemento por Departamento según Año y Mes, (en Toneladas Metricas) |
| **🗄️ Tabla(s) Almacén** | `INE;DATA_D_BO_000000017_01` |
| **📅 Última Migración** | **2026-08-28** |
"""

dag = DAG('M_BO_000000017',
...
create_dag(dag, connection_id='platform_db',id_dag='M_BO_000000017')#ALL=True)
