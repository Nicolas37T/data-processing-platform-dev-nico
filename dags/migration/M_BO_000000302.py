...
doc_md = """## 🚚 DAG Migración: M_BO_000000302
...
| **📄 Sub-reporte(s)** | Bmu-Ranking de Contingente |
| **🗄️ Tabla(s) Almacén** | `ASFI;DATA_D_BO_000000302_01` |
| **📅 Última Migración** | **2026-08-31** |
"""

dag = DAG('M_BO_000000302',
...
create_dag(dag, connection_id='platform_db',id_dag='M_BO_000000302')#ALL=True)
