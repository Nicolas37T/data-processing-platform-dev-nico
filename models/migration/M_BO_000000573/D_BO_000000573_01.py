"""Migration robot for report D_BO_000000573_01: Flujos Horarios por Nodo (CNDC)."""
...
class D_BO_000000573_01(Migration_Base):
    """Migration robot for D_BO_000000573_01."""
    ...
    def standard_report(self, dataframe: pd.DataFrame, conversion_factor: int) -> Tuple[dict, pd.DataFrame]:
        ...
        - Inyección / Retiro / Pérdidas / Energía: metrica = 'energia', unidad_metrica = 'MWh'
        - conversion_factor = 1
        """
        # Clean column names
