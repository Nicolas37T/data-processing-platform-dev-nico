"""Migration robot for report D_BO_000000301_01: Bmu-ranking de Cartera (ASFI)."""
...
class D_BO_000000301_01(Migration_Base):
    """Migration robot for D_BO_000000301_01."""
    ...
    def standard_report(self, dataframe: pd.DataFrame, conversion_factor: int) -> Tuple[dict, pd.DataFrame]:
        ...
        - Cartera: metrica = 'moneda', unidad_metrica = 'BOB' (o miles de BOB)
        ...
        def get_metric(val: str) -> str:
            ...
            if "%" in v or "particip" in v:
                ...
                return "posicion"
            elif "cartera" in v or "monto" in v:
                return "moneda"
            return "numero"
