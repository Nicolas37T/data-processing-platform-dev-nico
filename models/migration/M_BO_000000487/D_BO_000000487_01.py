"""Migration robot for report D_BO_000000487_01: Evolución de las Tasas de Referencia (BCB)."""
...
class D_BO_000000487_01(Migration_Base):
    """Migration robot for D_BO_000000487_01."""
    ...
    def standard_report(self, dataframe: pd.DataFrame, conversion_factor: int) -> Tuple[dict, pd.DataFrame]:
        ...
        - Tasas de Referencia: metrica = 'tasa', unidad_metrica = '%'
        - conversion_factor = 1
        """
        # Clean column names
