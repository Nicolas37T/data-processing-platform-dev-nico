"""Migration robot for report D_BO_000000481_07: Montos Negociados en Bolsa - Resumen Anual (BBV)."""
...
class D_BO_000000481_07(Migration_Base):
    """Migration robot for D_BO_000000481_07."""
    ...
    def standard_report(self, dataframe: pd.DataFrame, conversion_factor: int) -> Tuple[dict, pd.DataFrame]:
        ...
        - Part %: metrica = 'porcentaje', unidad_metrica = '%'
        - Monto: metrica = 'moneda', unidad_metrica = 'USD'
        - conversion_factor = 1
        """
