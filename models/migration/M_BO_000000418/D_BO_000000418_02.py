"""Migration robot for report D_BO_000000418_02: Tasas Pasivas por Entidad y Plazo (BCB)."""
...
class D_BO_000000418_02(Migration_Base):
    """Migration robot for D_BO_000000418_02."""
    ...
    def standard_report(self, dataframe: pd.DataFrame, conversion_factor: int) -> Tuple[dict, pd.DataFrame]:
        ...
        - Tasas de interés pasivas: metrica = 'tasa', unidad_metrica = '%'
        - conversion_factor = 1
        """
        # Clean column names
