...
class D_BO_000000018_01(Conversion_Base):
    ...
    def validate_data_results(
        ...
        totals = temp_df[total_mask].groupby("fecha")["_numeric_valor"].sum(min_count=1)
        components = (
            temp_df[~total_mask].groupby("fecha")["_numeric_valor"].sum(min_count=1)
        )
...
Executor_D_BO_000000018_01 = D_BO_000000018_01
