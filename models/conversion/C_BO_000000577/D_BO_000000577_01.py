"""Conversion robot for BCB silver quotations."""
...
class D_BO_000000577_01(Conversion_Base):
    """Convert BCB silver quotations to the platform format."""
    ...
    def extraction(
        ...
        """Extract and normalize the BCB silver quotation table.
        ...
        try:
            ...
            if normalized_keywords and "plata" not in normalized_keywords:
                raise ValueError(
                    "The configured keywords do not match silver."
                )
            ...
            if not report:
                raise ValueError("The silver table was not found.")
            ...
            if len(value_columns) != 2:
                raise ValueError(
                    "Expected two silver quotation columns, "
            ...
            for _, source_row in table.iterrows():
                ...
                for value_column in value_columns:
                    ...
                    normalized_column = normalized_headers[value_column]
                    if "DOLAR" in normalized_column:
                        level_name = (
                            "TIPO DE CAMBIO EN ONZA TROY PLATA(S) "
            ...
            if not records:
                raise ValueError("No silver quotations were extracted.")

            metadata = {
                "file_name": os.path.basename(file_path),
                "titles": ["PLATA COTIZACION"],
    ...
    def validate_data_results(
        ...
        """Validate numeric values from the silver quotation table.
        ...
        try:
            ...
            print(f"Could not validate the silver report: {error}")
            return True
