...
class D_BO_000000126(BCB_Boletin_Mensual):

    def get_file_url(self, main_url, updated_to, key_words = "central sector publico",format='%Y-%m-%d'):
        """
...
#     robot = D_BO_000000126()
#     # x = robot.get_file_url(main_url="https://www.bcb.gob.bo/?q=pub_boletin-estadistico",updated_to="2023-10-21")
#     # print(len(x))
#     # print(x)
#     files = [{'download_url': 'https://www.bcb.gob.bo/webdocs/publicacionesbcb/2024/04/10/01.01P.xlsx', 'tmp_path': "\\\\10.0.0.9\\SPIM\\BCB\\01-Informacion Estadistica\\03-Sector Bancario y Financiero\\03-Financiamiento concedido por\\01-Sistema Bancario – por Bancos\\tmp\\2024-05-07_11420203.01.xlsx"}]
#     y = robot.compare_files(files_paths=files,updated_to="2023-01-21")
#     print(y)

Executor_D_BO_000000126 = D_BO_000000126
Robot = D_BO_000000126
