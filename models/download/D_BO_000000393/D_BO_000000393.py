...
class D_BO_000000393(Download_Base):

    def get_file_url(self, main_url, updated_to, key_words = "santa cruz pib corrientes",format='%Y-%m-%d'):
        """
...
Executor_D_BO_000000393 = D_BO_000000393
Robot = D_BO_000000393
