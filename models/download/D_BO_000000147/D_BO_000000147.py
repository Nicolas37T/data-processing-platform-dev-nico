...
class D_BO_000000147(Download_Base):

    def get_file_url(self, main_url, updated_to, key_words = "comercializado interno",format='%Y-%m-%d'):
        """
...
Executor_D_BO_000000147 = D_BO_000000147
Robot = D_BO_000000147
