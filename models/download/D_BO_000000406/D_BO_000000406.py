...
class D_BO_000000406(Download_Base):

    def get_file_url(self, main_url, updated_to, key_words = "cochabamba pib constantes",format='%Y-%m-%d'):
        """
...
Executor_D_BO_000000406 = D_BO_000000406
Robot = D_BO_000000406
