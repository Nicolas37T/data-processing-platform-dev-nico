...
class D_BO_000000004(ASFI_Agencias_Bolsa):

    def get_file_url(self, main_url, updated_to, key_words = "bg bolsa",format='%Y-%m-%d'):
        """
...
Executor_D_BO_000000004 = D_BO_000000004
Robot = D_BO_000000004
