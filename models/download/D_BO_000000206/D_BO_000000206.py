...
#     robot = D_BO_000000206()
#     x = robot.get_data(main_url="https://estadisticas.minsalud.gob.bo/Reportes_Dinamicos/Menu_rep_dinamicos.aspx",updated_to="2023-12-21",path=r"\\10.0.0.9\spim\SNIS\Produccion de Servicios\28 Vacunacion en Niños de 4 Años")
#     print(x)
...
Executor_D_BO_000000206 = D_BO_000000206
Robot = D_BO_000000206
