...
class D_BO_000000266(BCB_Sector_Externo):

    def get_file_url(self, main_url, updated_to, key_words = "servicio debido deuda deudor",format='%Y-%m-%d'):
        """
...
Executor_D_BO_000000266 = D_BO_000000266
Robot = D_BO_000000266
