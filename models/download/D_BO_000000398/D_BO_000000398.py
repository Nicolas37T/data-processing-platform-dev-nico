...
class D_BO_000000398(Download_Base):

    def get_file_url(self, main_url, updated_to, key_words = "oruro pib constantes",format='%Y-%m-%d'):
        """
...
Executor_D_BO_000000398 = D_BO_000000398
Robot = D_BO_000000398
