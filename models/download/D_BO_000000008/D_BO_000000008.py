...
class D_BO_000000008(ASFI_Agencias_Bolsa):

    def get_file_url(self, main_url, updated_to, key_words = "volumen emisor",format='%Y-%m-%d'):
        """
...
Executor_D_BO_000000008 = D_BO_000000008
Robot = D_BO_000000008
