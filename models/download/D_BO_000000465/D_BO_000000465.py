...
class D_BO_000000465(Download_Base):
...
if __name__ == "__main__":
    robot = Executor_D_BO_000000465()
    # x =robot.get_file_url(main_url="https://api-cepalstat.cepal.org/cepalstat/api/v1/portal/cepalstat/updates?top=1000&app=portal&lang=es",updated_to='2023-05-03')
    # print(len(x))
    # print(x)
    files = [{'download_url': 'https://www.bcb.gob.bo/webdocs/publicacionesbcb/2024/04/10/01.01P.xlsx', 'tmp_path': r"/opt/airflow/models/download/D_BO_000000465/data_1722362484.xlsx"}]
    y = robot.compare_files(files_paths=files,updated_to="2023-01-21")
    print(y)


Executor_D_BO_000000465 = D_BO_000000465
Robot = D_BO_000000465
