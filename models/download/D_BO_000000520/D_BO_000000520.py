...
class D_BO_000000520(Download_Base):

    def get_file_url(self, main_url, updated_to, key_words = "pib corrientes actividad",format='%Y-%m-%d'):
        """
...
#     robot = Executor_D_BO_000000520()
    # x = robot.get_file_url(main_url="https://www.ine.gob.bo/index.php/estadisticas-economicas/pib-y-cuentas-nacionales/producto-interno-bruto-trimestral/producto-interno-bruto-trimestral-intro/#1604584724125-615aec14-e917",updated_to="2023-12-31")
    # print(len(x))
    # print(x)
    # files = [{'download_url': 'https://www.bcb.gob.bo/webdocs/publicacionesbcb/2024/04/10/01.01P.xlsx', 'tmp_path': r"C:\Users\Kevin Padilla\Downloads\01.02.01 (1).xlsx"}]
    # y = robot.compare_files(files_paths=files,updated_to="2023-01-21")
    # print(y)

Executor_D_BO_000000520 = D_BO_000000520
Robot = D_BO_000000520
