...
class D_BO_000000140(BCB_Boletin_Mensual):

    def get_file_url(self, main_url, updated_to, key_words = "balanza comercial",format='%Y-%m-%d'):
        """
    ...
    def compare_files(self, files_paths, updated_to, format='%Y-%m-%d'):
        ...
        for file in files_paths:
            ...
            dataframe_to_look = df_new_file.iloc[:7]
            matches = []
            ...
            years = [match.group() for match in matches if match.group()]
...
Executor_D_BO_000000140 = D_BO_000000140
Robot = D_BO_000000140
