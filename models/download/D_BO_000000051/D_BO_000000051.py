...
class D_BO_000000051(Download_Base):

    def get_file_url(self, main_url, updated_to, format='%Y-%m-%d',key_words='arrendamiento'):
        """
...
Executor_D_BO_000000051 = D_BO_000000051
Robot = D_BO_000000051
