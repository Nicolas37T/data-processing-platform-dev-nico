...
class D_BO_000000017(Download_Base):

    def get_file_url(self, main_url, updated_to, key_words="produccion cemento", format='%Y-%m-%d'):
        """
...
#     robot = D_BO_000000017()
#     # x = robot.get_file_url(main_url="https://www.ine.gob.bo/index.php/estadisticas-economicas/construccion/produccion-venta-y-consumo-de-cemento-cuadros-estadisticos/",updated_to="2023-9-21")
#     # print(x)
#     y = robot.compare_files(files_paths=[{"tmp_path": r"C:\Users\Kevin Padilla\Downloads\1. Bolivia - Produccion de Cemento por Departamento segun Año y Mes 1991 - 2024.xlsx"}],updated_to="2023-01-21")
#     print(y)

Executor_D_BO_000000017 = D_BO_000000017
Robot = D_BO_000000017
