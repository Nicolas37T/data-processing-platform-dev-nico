...
class D_BO_000000063(CNDC):

    def get_file_url(self, main_url, updated_to,key_words="curva carga" , format='%Y-%m-%d'):
        """
...
Executor_D_BO_000000063 = D_BO_000000063
Robot = D_BO_000000063
