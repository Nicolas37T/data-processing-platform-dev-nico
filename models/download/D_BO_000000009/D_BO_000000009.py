...
class D_BO_000000009(ASFI_Agencias_Bolsa):

    def get_file_url(self, main_url, updated_to, key_words = "operaciones tipo comprador",format='%Y-%m-%d'):
        """
...
Executor_D_BO_000000009 = D_BO_000000009
Robot = D_BO_000000009
