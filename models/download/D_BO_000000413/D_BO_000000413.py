...
class D_BO_000000413(Download_Base):

    def get_file_url(self, main_url, updated_to, key_words = "superficie agricola",format='%Y-%m-%d'):
        """
...
Executor_D_BO_000000413 = D_BO_000000413
Robot = D_BO_000000413
