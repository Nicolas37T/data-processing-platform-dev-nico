...
class D_BO_000000235(Tipo_Cambio):
    ...
    def verify_download(self, main_url, updated_to, path):
        ...
        return super().verify_download_main(main_url=main_url,updated_to=updated_to,path=path,key_words="china offshore")

# if __name__ == "__main__":
#     robot = D_BO_000000235()
...
#     # print(y)<a href="./excelDatosP.php" <button class="boton"> Descargar Excel </a>

Executor_D_BO_000000235 = D_BO_000000235
Robot = D_BO_000000235
