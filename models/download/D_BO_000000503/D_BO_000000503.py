...
class D_BO_000000503(BCB_Boletin_Mensual):

    def get_file_url(self, main_url, updated_to, key_words = "exportacion minerales oficial",format='%Y-%m-%d'):
        """
    ...
    def compare_files(self, files_paths, updated_to, format='%Y-%m-%d'):
        ...
        for file in files_paths:
            ...
            re_year = r'^(\d{4})\s*[(]?p?[)]?'
            re_month = r"^((?:ene|feb|mar|abr|may|jun|jul|ago|sep|oct|nov|dic))"
...
#     robot = Executor_D_BO_000000503()
    # x = robot.get_file_url(main_url="https://www.bcb.gob.bo/?q=pub_boletin-estadistico",updated_to="2023-12-31")
    # print(len(x))
    # print(x)
    # files = [{'download_url': 'https://www.bcb.gob.bo/webdocs/publicacionesbcb/2024/04/10/01.01P.xlsx', 'tmp_path': r"C:\Users\Kevin Padilla\Downloads\09.04.xlsx"}]
    # y = robot.compare_files(files_paths=files,updated_to="2023-01-21")
    # print(y)

Executor_D_BO_000000503 = D_BO_000000503
Robot = D_BO_000000503
