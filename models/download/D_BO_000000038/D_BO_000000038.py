...
class D_BO_000000038(Download_Base):
    ...
    def get_file_url(self, main_url, updated_to, format='%Y-%m-%d'):
        ...
        with sync_playwright() as pl:
            ...
            files_rows_xpath = '//div[@class="view-content"]/div'
            ...
            try:
                ...
                for attempt in range(1, max_retries+1):
                    try:
                        ...
                        page.wait_for_selector(files_rows_xpath, state="visible",timeout=10*1000)
                        break
                    except Exception:
...
#     robot = D_BO_000000038()
#     # x = robot.get_file_url(main_url="https://www.bcb.gob.bo/?q=resultado-subastas-bonos-tesoro",updated_to="2023-1-21")
#     # print(x)
#     y = robot.compare_files(files_paths=[{"tmp_path": r"C:\Users\Kevin Padilla\Downloads\BT-26-2023 Desmat_TR.pdf"}],updated_to="2023-01-21")
#     print(y)

Executor_D_BO_000000038 = D_BO_000000038
Robot = D_BO_000000038
