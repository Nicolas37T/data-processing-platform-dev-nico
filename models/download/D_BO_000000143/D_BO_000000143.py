...
class D_BO_000000143(BCB_Boletin_Mensual):

    def get_file_url(self, main_url, updated_to, key_words = "empresas publicas",format='%Y-%m-%d'):
        """
...
Executor_D_BO_000000143 = D_BO_000000143
Robot = D_BO_000000143
