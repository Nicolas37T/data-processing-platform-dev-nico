...
class D_BO_000000097(BCB_Sector_Monetario):

    def get_file_url(self, main_url, updated_to, key_words = "encaje legal",format='%Y-%m-%d'):
        """
    ...
    def compare_files(self, files_paths, updated_to, format='%Y-%m-%d'):
        ...
        for file in files_paths:
            ...
            date_formated = dates.iloc[-1] + pd.offsets.MonthEnd(0)
            print(date_formated)
...
Executor_D_BO_000000097 = D_BO_000000097
Robot = D_BO_000000097
