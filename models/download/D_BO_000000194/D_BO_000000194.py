...
#     robot = D_BO_000000194()
#     x = robot.get_data(main_url="https://estadisticas.minsalud.gob.bo/Reportes_Dinamicos/Menu_rep_dinamicos.aspx",updated_to="2023-12-21",path=r"\\10.0.0.9\spim\SNIS\Produccion de Servicios\11 Atencion de Partos en Domicilio")
#     print(x)
...
Executor_D_BO_000000194 = D_BO_000000194
Robot = D_BO_000000194
