...
class D_BO_000000166(Download_Base):

    def get_file_url(self, main_url, updated_to, key_words = "indice remuneracion nominal ocupacional",format='%Y-%m-%d'):
        """
...
Executor_D_BO_000000166 = D_BO_000000166
Robot = D_BO_000000166
