...
class D_BO_000000122(BCB_Boletin_Mensual):

    def get_file_url(self, main_url, updated_to, key_words = "financieras vivienda",format='%Y-%m-%d'):
        """
...
Executor_D_BO_000000122 = D_BO_000000122
Robot = D_BO_000000122
