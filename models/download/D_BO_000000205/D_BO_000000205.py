...
class D_BO_000000205(SNIS):
    ...
    def get_data(self, main_url,path, updated_to,format='%Y-%m-%d'):
        ...
        variable={
            "code":"27",
            "key_words":"vacunaciones2 a 3años"
            }
        form_code='301'
...
#     robot = D_BO_000000205()
#     x = robot.get_data(main_url="https://estadisticas.minsalud.gob.bo/Reportes_Dinamicos/Menu_rep_dinamicos.aspx",updated_to="2024-12-21",path=r"\\10.0.0.9\spim\SNIS\Produccion de Servicios\27 Vacunaciones en Niños de 2 a 3 Años")
#     print(x)
...
Executor_D_BO_000000205 = D_BO_000000205
Robot = D_BO_000000205
