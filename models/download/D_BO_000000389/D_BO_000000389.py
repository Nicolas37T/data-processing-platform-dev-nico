...
class D_BO_000000389(Download_Base):

    def get_file_url(self, main_url, updated_to, key_words = "variacion gasto",format='%Y-%m-%d'):
        """
...
Executor_D_BO_000000389 = D_BO_000000389
Robot = D_BO_000000389
