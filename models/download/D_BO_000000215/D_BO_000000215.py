...
class D_BO_000000215(SNIS):
    ...
    def get_data(self, main_url,path, updated_to,format='%Y-%m-%d'):
        ...
        variable={
            "code":"05",
            "key_words":"servicios complementarios"
            }
        form_code='304'
...
#     robot = D_BO_000000215()
#     x = robot.get_data(main_url="https://estadisticas.minsalud.gob.bo/Reportes_Dinamicos/Menu_rep_dinamicos.aspx",updated_to="2024-12-21",path=r"\\10.0.0.9\spim\SNIS\Produccion de Servicios 2\05 Servicios Complementarios")
#     print(x)
...
Executor_D_BO_000000215 = D_BO_000000215
Robot = D_BO_000000215
