...
class D_BO_000000134(BCB_Boletin_Mensual):

    def get_file_url(self, main_url, updated_to, key_words = "privado cuentas departamentos",format='%Y-%m-%d'):
        """
...
Executor_D_BO_000000134 = D_BO_000000134
Robot = D_BO_000000134
