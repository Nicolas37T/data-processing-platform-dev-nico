...
class D_BO_000000086(BCB_Boletin_Mensual):

    def get_file_url(self, main_url, updated_to, key_words = "estructura tasas",format='%Y-%m-%d'):
        """
...
Executor_D_BO_000000086 = D_BO_000000086
Robot = D_BO_000000086
