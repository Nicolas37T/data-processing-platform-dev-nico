...
class D_BO_000000064(CNDC):

    def get_file_url(self, main_url, updated_to,key_words="cargos inyecciones" , format='%Y-%m-%d'):
        """
...
Executor_D_BO_000000064 = D_BO_000000064
Robot = D_BO_000000064
