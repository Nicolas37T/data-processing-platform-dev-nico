...
class D_BO_000000281(ASFI):
    ...
    def compare_files(self, files_paths, updated_to, format='%Y-%m-%d'):
        ...
        files_dicts = super().compare_files_main(files_paths=files_paths, updated_to=updated_to, RE_DATE=r'(\d{4})\D(\d{1,2})\D(\d{1,2})',TYPE=2)
        return files_dicts
    
if __name__ == "__main__":
    robot = Executor_D_BO_000000281()
...
Executor_D_BO_000000281 = D_BO_000000281
Robot = D_BO_000000281
