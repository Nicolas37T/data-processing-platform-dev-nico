...
class D_BO_000000137(BCB_Boletin_Mensual):

    def get_file_url(self, main_url, updated_to, key_words = "banca comercial",format='%Y-%m-%d'):
        """
...
Executor_D_BO_000000137 = D_BO_000000137
Robot = D_BO_000000137
