...
class D_BO_000000090(Download_Base):

    def get_file_url(self, main_url, updated_to, key_words = "encaje mn",format='%Y-%m-%d'):
        """
...
Executor_D_BO_000000090 = D_BO_000000090
Robot = D_BO_000000090
