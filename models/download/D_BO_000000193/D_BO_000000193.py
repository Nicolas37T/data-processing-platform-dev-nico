...
class D_BO_000000193(SNIS):
    ...
    def get_data(self, main_url,path, updated_to,format='%Y-%m-%d'):
        ...
        variable={
            "code":"34",
            "key_words":"partos domicilio servicios"
            }
        form_code='301'
...
#     robot = D_BO_000000193()
#     x = robot.get_data(main_url="https://estadisticas.minsalud.gob.bo/Reportes_Dinamicos/Menu_rep_dinamicos.aspx",updated_to="2024-12-21",path=r"\\10.0.0.9\spim\SNIS\Produccion de Servicios\10 Atencion de Partos en Servicios")
#     print(x)
...
Executor_D_BO_000000193 = D_BO_000000193
Robot = D_BO_000000193
