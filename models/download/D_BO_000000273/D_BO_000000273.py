...
class D_BO_000000273(Download_Base):

    def get_file_url(self, main_url, updated_to, key_words = "pib capita dolares",format='%Y-%m-%d'):
        """
...
Executor_D_BO_000000273 = D_BO_000000273
Robot = D_BO_000000273
