...
class D_BO_000000274(Download_Base):

    def get_file_url(self, main_url, updated_to, key_words = "pib capita bolivianos",format='%Y-%m-%d'):
        """
...
Executor_D_BO_000000274 = D_BO_000000274
Robot = D_BO_000000274
