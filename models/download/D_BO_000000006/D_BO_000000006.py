...
class D_BO_000000006(ASFI_Agencias_Bolsa):

    def get_file_url(self, main_url, updated_to, key_words = "operaciones bolsa comprado",format='%Y-%m-%d'):
        """
...
Executor_D_BO_000000006 = D_BO_000000006
Robot = D_BO_000000006
