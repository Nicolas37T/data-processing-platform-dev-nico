...
import pandas as pd
from models.download.tools.download_tools import search_key_words, format_date, delete_hidden_sheets, month_abr_to_number, month_to_number, last_day_month
from models.download.Download_Base import Download_Base

class D_BO_000000409(Download_Base):

    def get_file_url(self, main_url, updated_to, key_words = "energia electrica",format='%Y-%m-%d'):
        """
    ...
    def compare_files(self, files_paths, updated_to, format='%Y-%m-%d'):
        ...
        for file in files_paths: 
            ...
            re_year = r'(\d{4})\s*[(]?p?[)]?'
            re_month = r"((?:enero|febrero|marzo|abril|mayo|junio|julio|agosto|septiembre|octubre|noviembre|diciembre))"
...
#     # print(len(x))
#     # print(x)
#     files = [{'download_url': 'https://nube.ine.gob.bo/index.php/s/YjA7ClnBp3KxZM0/download', 'tmp_path': '\\\\10.0.0.9\\spim\\INE\\Estadísticas por Actividad Económica\\Servicios Basicos\\tmp\\2024-06-06_092253download.xlsx'}]
#     y = robot.compare_files(files_paths=files,updated_to="2023-01-21")
#     print(y)

Executor_D_BO_000000409 = D_BO_000000409
Robot = D_BO_000000409
