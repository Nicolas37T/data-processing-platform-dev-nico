...
class D_BO_000000553(Download_Base):
	...
	def verify_download(self, main_url, updated_to, path, format='%Y-%m-%d'):
		...
		with sync_playwright() as pl:        
            ...
            # air transport volume index national
			atv_index_nat_xpath = '(//div[@class="standard-arrow list-divider bullet-top"]/ul/li/a)[10]'
			...
			try:
				...
				link = page.locator(atv_index_nat_xpath)                                                         
				...
				# Bolivia – Índice de Volumen de Transporte Aéreo por Ruta y Tipo de Servicio Nacional según Año y Mes, 1990 – 2024
				download_path = os.path.join(path,"atv_index_nat.xlsx")                  
...
Executor_D_BO_000000553 = D_BO_000000553
Robot = D_BO_000000553
