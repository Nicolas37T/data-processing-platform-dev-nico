...
class D_BO_000000446(Download_Base):

    def get_file_url(self, main_url, updated_to, key_words = "salida carretera nacionalidad",format='%Y-%m-%d'):
        """
...
Executor_D_BO_000000446 = D_BO_000000446
Robot = D_BO_000000446
