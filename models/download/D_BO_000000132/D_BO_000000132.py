...
class D_BO_000000132(BCB_Boletin_Mensual):

    def get_file_url(self, main_url, updated_to, key_words = "caja ahorros monedas",format='%Y-%m-%d'):
        """
...
Executor_D_BO_000000132 = D_BO_000000132
Robot = D_BO_000000132
