...
class D_BO_000000073(CNDC):

    def get_file_url(self, main_url, updated_to,key_words="costo genera" , format='%Y-%m-%d'):
        """
...
Executor_D_BO_000000073 = D_BO_000000073
Robot = D_BO_000000073
