...
class D_BO_000000042(Download_Base):
    ...
    def get_file_url(self, main_url, updated_to, format='%Y-%m-%d'):
        ...
        with sync_playwright() as pl:
            ...
            # Xpath elements
            files_rows_xpath = '//article[@class="c2"]'
            ...
            try:
                ...
                page.wait_for_selector('//article[@class="c2"][last()]',state="visible")
                # Get all rows of interest from the page
                files_rows = page.query_selector_all(files_rows_xpath)
                for row in files_rows:
                    ...
                    if date:
                        ...
                        if date_formated>updated_to:
                            urls = row.query_selector_all('//a[@class="c2-link"]')
...
#     robot = D_BO_000000042()
#     # x = robot.get_file_url(main_url="https://www.bcr.com.ar/es/mercados/boletin-diario/mercado-de-granos",updated_to="2023-1-21")
#     # print(x)
#     y = robot.compare_files(files_paths=[{"tmp_path": r"C:\Users\Kevin Padilla\Downloads\boletin-mercado-granos-18541.pdf"}],updated_to="2023-01-21")
#     print(y)

Executor_D_BO_000000042 = D_BO_000000042
Robot = D_BO_000000042
