...
class D_BO_000000111(BCB_Boletin_Mensual):

    def get_file_url(self, main_url, updated_to, key_words = "sistema monetario",format='%Y-%m-%d'):
        """
...
Executor_D_BO_000000111 = D_BO_000000111
Robot = D_BO_000000111
