...
class D_BO_000000115(BCB_Boletin_Mensual):

    def get_file_url(self, main_url, updated_to, key_words = "bancos comerciales",format='%Y-%m-%d'):
        """
...
Executor_D_BO_000000115 = D_BO_000000115
Robot = D_BO_000000115
