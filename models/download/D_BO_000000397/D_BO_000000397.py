...
class D_BO_000000397(Download_Base):

    def get_file_url(self, main_url, updated_to, key_words = "pando pib corrientes",format='%Y-%m-%d'):
        """
...
Executor_D_BO_000000397 = D_BO_000000397
Robot = D_BO_000000397
