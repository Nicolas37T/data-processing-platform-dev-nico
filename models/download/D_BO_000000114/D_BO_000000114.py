...
class D_BO_000000114(BCB_Boletin_Mensual):

    def get_file_url(self, main_url, updated_to, key_words = "2.05 bancos comerciales",format='%Y-%m-%d'):
        """
...
Executor_D_BO_000000114 = D_BO_000000114
Robot = D_BO_000000114
