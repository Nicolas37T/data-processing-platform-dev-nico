...
class D_BO_000000378(ASFI):
    ...
    def get_file_url(self, main_url, updated_to,format='%Y-%m-%d'):
        ...
        files_urls = super().get_file_url_main(main_url=main_url,updated_to=updated_to,SECTION=r"colocaciones",KEY_WORDS=r"clasif.*cartera.*tipo.*credito")
        return files_urls
...
Executor_D_BO_000000378 = D_BO_000000378
Robot = D_BO_000000378
