...
from models.download.tools.download_tools import format_date, last_day_month,text_extract
from models.download.Download_Base import Download_Base

class D_BO_000000259(Download_Base):
    ...
    def get_file_url(self, main_url, updated_to,format='%Y-%m-%d'):
        ...
        re_month = r"((?:primer|segundo|tercer|cuarto))"
        ...
        try:
            ...
            for year in range(updated_to.year,today.year+1):
                ...
                url = f"https://www.aps.gob.bo/?option=com_ajax&module=apsfilesdisplayer&method=getFiles&format=json&folder=webdocs___UNE___DS___Estadisticas___SOAT+-+Trimestral___{year}&format=json"
    ...
    def compare_files(self, files_paths, updated_to, format='%Y-%m-%d'):
        ...
        re_year = r'gestión\s(\d{4})'
        re_month = r'((?:primer|segundo|tercer|cuarto))\s*trimestre'
...
#     robot = D_BO_000000259()
#     # x = robot.get_file_url(main_url="http://senamhi.gob.bo/index.php/pcpn",updated_to="2023-5-21")
#     # print(len(x))
#     # print(x)
#     files = [{'download_url': 'https://www.bcb.gob.bo/webdocs/publicacionesbcb/2024/04/10/01.01P.xlsx', 'tmp_path': r"C:\Users\Kevin Padilla\Downloads\Primer Trimestre.pdf"}]
#     y = robot.compare_files(files_paths=files,updated_to="2023-01-21")
#     print(y)

Executor_D_BO_000000259 = D_BO_000000259
Robot = D_BO_000000259
