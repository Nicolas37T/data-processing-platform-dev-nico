...
class D_BO_000000128(BCB_Boletin_Mensual):

    def get_file_url(self, main_url, updated_to, key_words = "cuenta corriente departamentos",format='%Y-%m-%d'):
        """
...
Executor_D_BO_000000128 = D_BO_000000128
Robot = D_BO_000000128
