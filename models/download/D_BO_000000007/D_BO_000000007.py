...
class D_BO_000000007(ASFI_Agencias_Bolsa):

    def get_file_url(self, main_url, updated_to, key_words = "operaciones vendedora",format='%Y-%m-%d'):
        """
...
Executor_D_BO_000000007 = D_BO_000000007
Robot = D_BO_000000007
