...
class D_BO_000000430(Download_Base):

    def get_file_url(self, main_url, updated_to, key_words = "pando red rodadura",format='%Y-%m-%d'):
        """
...
Executor_D_BO_000000430 = D_BO_000000430
Robot = D_BO_000000430
