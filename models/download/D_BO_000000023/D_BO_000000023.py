...
import pandas as pd
from models.download.tools.download_tools import format_date, delete_hidden_sheets,last_day_month,get_date_method_1, search_key_words
from models.download.Download_Base import Download_Base

class D_BO_000000023(Download_Base):

    def get_file_url(self, main_url, updated_to, key_words="servicios basicos", format='%Y-%m-%d'):
        """
        ...
        with sync_playwright() as pl:
            ...
            try:
                ...
                files_link_searched = [link.get_attribute(
                    'href') for link in elements if search_key_words(text=link.inner_text().lower(),key_word=key_words) ]
    ...
    def compare_files(self, files_paths, updated_to, format='%Y-%m-%d'):
        ...
        for file in files_paths:
            ...
            date = get_date_method_1(dataframe=df_new_file)
...
#     robot = D_BO_000000023()
#     # x = robot.get_file_url(main_url="https://www.ine.gob.bo/index.php/estadisticas-economicas/servicios-basicos-cuadros-estadisticos/",updated_to="2023-9-21")
#     # print(x)
#     y = robot.compare_files(files_paths=[{"tmp_path": r"C:\Users\Kevin Padilla\Downloads\1. BOLIVIA - ÍNDICE GENERAL DE CONSUMO DE SERVICIOS BASICOS POR TIPO DE SERVICIO SEGÚN AÑO Y MES, 1990 - 2024 (1).xlsx"}],updated_to="2023-01-21")
#     print(y)

Executor_D_BO_000000023 = D_BO_000000023
Robot = D_BO_000000023
