...
class D_BO_000000152(Download_Base):

    def get_file_url(self, main_url, updated_to, key_words = "pib constantes gasto",format='%Y-%m-%d'):
        """
...
Executor_D_BO_000000152 = D_BO_000000152
Robot = D_BO_000000152
