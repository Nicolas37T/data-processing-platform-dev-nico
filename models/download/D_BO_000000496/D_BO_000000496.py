...
class D_BO_000000496(Download_Base):
...
#     robot = Executor_D_BO_000000496()
#     x =robot.check_new_data(main_url="https://www.global-rates.com/en/interest-rates/euribor/euribor.aspx",updated_to='2024-08-01', path=r"D:\DATAX\data-processing-platform\local_downloads\APS", key_words=" oro plata")
#     print(len(x))
#     print(x)
...
Executor_D_BO_000000496 = D_BO_000000496
Robot = D_BO_000000496
