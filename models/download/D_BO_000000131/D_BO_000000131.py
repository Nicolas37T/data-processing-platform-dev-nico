...
class D_BO_000000131(BCB_Boletin_Mensual):

    def get_file_url(self, main_url, updated_to, key_words = "cuenta corriente monedas",format='%Y-%m-%d'):
        """
...
Executor_D_BO_000000131 = D_BO_000000131
Robot = D_BO_000000131
