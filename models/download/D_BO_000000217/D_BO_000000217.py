...
#     robot = D_BO_000000217()
#     x = robot.get_data(main_url="https://estadisticas.minsalud.gob.bo/Reportes_Dinamicos/Menu_rep_dinamicos.aspx",updated_to="2024-12-21",path=r"\\10.0.0.9\spim\SNIS\Produccion de Servicios 2\07 Gestion de Calidad")
#     print(x)
...
Executor_D_BO_000000217 = D_BO_000000217
Robot = D_BO_000000217
