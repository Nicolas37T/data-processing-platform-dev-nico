...
class D_BO_000000082(BCB_Boletin_Mensual):

    def get_file_url(self, main_url, updated_to, key_words = "cuenta corriente",format='%Y-%m-%d'):
        """
...
#     robot = D_BO_000000082()
#     # x = robot.get_file_url(main_url="https://www.bcb.gob.bo/?q=pub_boletin-mensual",updated_to="2023-10-21")
#     # print(len(x))
#     y = robot.compare_files(files_paths="https://www.bcb.gob.bo/?q=pub_boletin-mensual",updated_to="2023-01-21")
#     print(y)

Executor_D_BO_000000082 = D_BO_000000082
Robot = D_BO_000000082
