...
class D_BO_000000405(Download_Base):

    def get_file_url(self, main_url, updated_to, key_words = "beni pib corrientes",format='%Y-%m-%d'):
        """
...
Executor_D_BO_000000405 = D_BO_000000405
Robot = D_BO_000000405
