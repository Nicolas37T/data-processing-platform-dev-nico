...
class D_BO_000000029(Download_Base):
    ...
    def get_file_url(self, main_url, updated_to, format='%Y-%m-%d'):
        ...
        with sync_playwright() as pl:
            ...
            try:
                ...
                page.wait_for_selector('//a[contains(text(), "Pasivas")]',state='visible')
                ...
                index_searched = [index for index,value in enumerate(files_urls[7].inner_text().split("\n")) if re.search(r"\d{4}",value) and int(re.search(r"\d{4}",value).group()) >= updated_to.year]
...
Executor_D_BO_000000029 = D_BO_000000029
Robot = D_BO_000000029
