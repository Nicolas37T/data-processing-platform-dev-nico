...
class D_BO_000000130(BCB_Boletin_Mensual):

    def get_file_url(self, main_url, updated_to, key_words = "plazo fijo departamentos",format='%Y-%m-%d'):
        """
...
Executor_D_BO_000000130 = D_BO_000000130
Robot = D_BO_000000130
