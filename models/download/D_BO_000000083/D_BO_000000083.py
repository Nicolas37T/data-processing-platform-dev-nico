...
class D_BO_000000083(BCB_Boletin_Mensual):

    def get_file_url(self, main_url, updated_to, key_words = "depositos fijo privado",format='%Y-%m-%d'):
        """
...
Executor_D_BO_000000083 = D_BO_000000083
Robot = D_BO_000000083
