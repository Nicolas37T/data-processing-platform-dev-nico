...
class D_BO_000000181(SNIS):
    ...
    def get_data(self, main_url,path, updated_to,format='%Y-%m-%d'):
        ...
        variable={
            "code":"17",
            "key_words":"enfermedades vectores"
            }
        form_code='302'
...
#     robot = D_BO_000000181()
#     x = robot.get_data(main_url="https://estadisticas.minsalud.gob.bo/Reportes_Dinamicos/Menu_rep_dinamicos.aspx",updated_to="2024-12-21",path=r"\\10.0.0.9\spim\SNIS\Vigilancia Epidemiologica\12 Enfermedades Transmitidas por Vectores (ETV)")
#     print(x)
...
Executor_D_BO_000000181 = D_BO_000000181
Robot = D_BO_000000181
