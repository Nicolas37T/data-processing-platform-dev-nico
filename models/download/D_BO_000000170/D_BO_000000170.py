...
#     robot = Executor_D_BO_000000170()
#     x = robot.get_data(main_url="https://estadisticas.minsalud.gob.bo/Reportes_Dinamicos/Menu_rep_dinamicos.aspx",path=r"/media/spim_10009/SNIS/Vigilancia Epidemiologica/01 sospecha_diagnostica")
#     print(x)

Executor_D_BO_000000170 = D_BO_000000170
Robot = D_BO_000000170
