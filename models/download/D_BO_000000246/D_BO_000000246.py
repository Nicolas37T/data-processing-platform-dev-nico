...
class D_BO_000000246(Tipo_Cambio):
    ...
    def verify_download(self, main_url, updated_to, path):
        ...
        return super().verify_download_main(main_url=main_url,updated_to=updated_to,path=path,key_words="taiwan")

# if __name__ == "__main__":
#     robot = D_BO_000000246()
...
Executor_D_BO_000000246 = D_BO_000000246
Robot = D_BO_000000246
