...
class D_BO_000000127(BCB_Boletin_Mensual):

    def get_file_url(self, main_url, updated_to, key_words = "resto sistema privado",format='%Y-%m-%d'):
        """
...
Executor_D_BO_000000127 = D_BO_000000127
Robot = D_BO_000000127
