...
class D_BO_000000069(CNDC):

    def get_file_url(self, main_url, updated_to,key_words="inyeccion retiro" , format='%Y-%m-%d'):
        """
...
Executor_D_BO_000000069 = D_BO_000000069
Robot = D_BO_000000069
