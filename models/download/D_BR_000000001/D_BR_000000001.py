...
class D_BR_000000001(Download_Base):
    ...
    def get_file_url(self, main_url, updated_to, format='%Y-%m-%d'):
        ...
        try:
            with sync_playwright() as pl:
                ...
                link_searched = [item.get_attribute('href') for item in page.locator(links_xpath).all() if re.search(r'emissor',item.get_attribute('href'), re.IGNORECASE)]
...
Executor_D_BR_000000001 = D_BR_000000001
Robot = D_BR_000000001
