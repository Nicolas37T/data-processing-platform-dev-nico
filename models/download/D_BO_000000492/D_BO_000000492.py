...
class D_BO_000000492(CNDC):

    def get_file_url(self, main_url, updated_to, key_words="despacho empresa",format='%Y-%m-%d'):
        """
...
Executor_D_BO_000000492 = D_BO_000000492
Robot = D_BO_000000492
