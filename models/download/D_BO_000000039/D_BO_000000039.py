...
class D_BO_000000039(Download_Base):
            ...
            try:
                ...
                for attempt in range(1, max_retries+1):
                    try:
                        ...
                        page.wait_for_selector('//*[@id="quicktabs-tabpage-resultado_de_subastas_letras_del-0"]//div[@class="view-content"]/div', state="visible",timeout=10*1000)
                        break
                    except Exception:
                ...
                files_rows = page.query_selector_all('//*[@id="quicktabs-tabpage-resultado_de_subastas_letras_del-0"]//div[@class="view-content"]/div')
...
Executor_D_BO_000000039 = D_BO_000000039
Robot = D_BO_000000039
