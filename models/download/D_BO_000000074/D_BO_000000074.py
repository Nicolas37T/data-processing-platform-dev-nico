...
class D_BO_000000074(CNDC):

    def get_file_url(self, main_url, updated_to,key_words="costo nodo" , format='%Y-%m-%d'):
        """
...
Executor_D_BO_000000074 = D_BO_000000074
Robot = D_BO_000000074
