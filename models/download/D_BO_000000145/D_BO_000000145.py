...
import pandas as pd
from models.download.tools.download_tools import search_key_words, format_date, month_abr_to_number,month_to_number,last_day_month, delete_hidden_sheets
from models.download.Download_Base import Download_Base

class D_BO_000000145(Download_Base):

    def get_file_url(self, main_url, updated_to, key_words = "variacion 12 meses ciudad",format='%Y-%m-%d'):
        """
    ...
    def compare_files(self, files_paths, updated_to, format='%Y-%m-%d'):
        ...
        for file in files_paths: 
            ...
            df_new_file = pd.read_excel(file["tmp_path"],sheet_name=1,header=[4,5])
...
#     robot = D_BO_000000145()
#     # x = robot.get_file_url(main_url="https://www.ine.gob.bo/index.php/serie-historica-empalmada/",updated_to="2023-10-21")
#     # print(len(x))
#     # print(x)
...
Executor_D_BO_000000145 = D_BO_000000145
Robot = D_BO_000000145
