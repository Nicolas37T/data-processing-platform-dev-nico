...
class D_BO_000000550(Download_Base):
    ...
    def verify_download(self,main_url, updated_to, path, format='%Y-%m-%d'):
        ...
        with sync_playwright() as pl:        
            ...
            departure_xpath = '(//div[@class="standard-arrow list-divider bullet-top"]/ul/li/a)[8]'
            ...
            try:
                ...
                link = page.locator(departure_xpath)
                ...
                if max_year>= updated_to.year:                                    
                    ...
                    # Bolivia-Salida de Viajeros Internacionales, Por Modo de Transporte y Tipo de Viajero Según Año y Mes 2008 -2025
                    download_path = os.path.join(path, str(max_year)+"_"+"departure.xlsx")  
...
Executor_D_BO_000000550 = D_BO_000000550
Robot = D_BO_000000550
