...
class D_BO_000000197(SNIS):
    ...
    def get_data(self, main_url,path, updated_to,format='%Y-%m-%d'):
        ...
        variable={
            "code":"16",
            "key_words":"vacunaciones12 a 23meses"
            }
        form_code='301'
...
#     robot = D_BO_000000197()
#     x = robot.get_data(main_url="https://estadisticas.minsalud.gob.bo/Reportes_Dinamicos/Menu_rep_dinamicos.aspx",updated_to="2023-12-21",path=r"\\10.0.0.9\spim\SNIS\Produccion de Servicios\16 Vacunaciones en Niños de 12 a 23 Meses")
#     print(x)
...
Executor_D_BO_000000197 = D_BO_000000197
Robot = D_BO_000000197
