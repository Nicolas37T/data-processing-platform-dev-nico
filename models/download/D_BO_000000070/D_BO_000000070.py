...
class D_BO_000000070(CNDC):

    def get_file_url(self, main_url, updated_to,key_words="prevista real" , format='%Y-%m-%d'):
        """
...
Executor_D_BO_000000070 = D_BO_000000070
Robot = D_BO_000000070
