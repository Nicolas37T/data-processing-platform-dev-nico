...
class D_BO_000000165(Download_Base):

    def get_file_url(self, main_url, updated_to, key_words = "remuneracion nominal actividad 1996",format='%Y-%m-%d'):
        """
...
Executor_D_BO_000000165 = D_BO_000000165
Robot = D_BO_000000165
