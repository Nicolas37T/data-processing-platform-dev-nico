...
class D_BO_000000385(Download_Base):

    def get_file_url(self, main_url, updated_to, key_words = "pib constantes gasto 1988",format='%Y-%m-%d'):
        """
    ...
    def compare_files(self, files_paths, updated_to, format='%Y-%m-%d'):
        ...
        for file in files_paths: 
            ...
            sub_set =  df_new_file[df_new_file.iloc[:, 0]=="T I P O    D E    G A S T O"].values.tolist()
...
#     # print(len(x))
#     # print(x)
#     files = [{'download_url': 'https://nube.ine.gob.bo/index.php/s/MMZk52HlU4b9EWT/download', 'tmp_path': '\\\\10.0.0.9\\spim\\INE\\Cuentas Nacionales\\Producto Iinterno Bruto Anual\\Producto Interno Bruto por Tipo de Gasto\\tmp\\2024-06-05_161528download.xlsx'}]
#     y = robot.compare_files(files_paths=files,updated_to="2023-01-21")
#     print(y)

Executor_D_BO_000000385 = D_BO_000000385
Robot = D_BO_000000385
