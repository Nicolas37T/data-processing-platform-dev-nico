...
class D_BO_000000167(Download_Base):

    def get_file_url(self, main_url, updated_to, key_words = "indice salario nominal ocupacional",format='%Y-%m-%d'):
        """
...
Executor_D_BO_000000167 = D_BO_000000167
Robot = D_BO_000000167
