...
class D_BO_000000424(Download_Base):

    def get_file_url(self, main_url, updated_to, key_words = "cochabamba red rodadura",format='%Y-%m-%d'):
        """
    ...
    def compare_files(self, files_paths, updated_to, format='%Y-%m-%d'):
        ...
        for file in files_paths: 
            ...
            sub_set =  df_new_file[df_new_file.iloc[:, 0]=="TIPO DE RODADURA"].values.tolist()
...
#     # print(len(x))
#     # print(x)
#     files = [{'download_url': 'https://nube.ine.gob.bo/index.php/s/PnEqp7IopHEJDBu/download', 'tmp_path': '\\\\10.0.0.9\\spim\\INE\\Estadisticas Economicas\\Construcción\\Longitud de Caminos\\Longitud de Caminos según Red y Superficie de Rodadura\\tmp\\2024-06-11_121820download.xlsx'}]
#     y = robot.compare_files(files_paths=files,updated_to="2022-01-21")
#     print(y)

Executor_D_BO_000000424 = D_BO_000000424
Robot = D_BO_000000424
