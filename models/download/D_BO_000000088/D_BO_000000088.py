...
class D_BO_000000088(Download_Base):

    def get_file_url(self, main_url, updated_to, key_words = "encaje mv",format='%Y-%m-%d'):
        """
...
Executor_D_BO_000000088 = D_BO_000000088
Robot = D_BO_000000088
