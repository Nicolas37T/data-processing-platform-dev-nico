...
class D_BO_000000400(Download_Base):

    def get_file_url(self, main_url, updated_to, key_words = "la paz pib constantes",format='%Y-%m-%d'):
        """
...
Executor_D_BO_000000400 = D_BO_000000400
Robot = D_BO_000000400
