...
class D_BO_000000391(Download_Base):

    def get_file_url(self, main_url, updated_to, key_words = "tarija pib corrientes",format='%Y-%m-%d'):
        """
...
Executor_D_BO_000000391 = D_BO_000000391
Robot = D_BO_000000391
