...
class D_BO_000000173(SNIS_BY_PARTS):
    ...
    def get_data(self, main_url,path, updated_to,format='%Y-%m-%d'):
        ...
        return super().verify_download(main_url=main_url, path=path,filters_order=filters_order,variable=variable,form_code=form_code,NUMBER_SPLIT=3, COLUMN_TO_SPLIT=3)

# if __name__ == "__main__":
#     robot = D_BO_000000173()
#     x = robot.get_data(main_url="https://estadisticas.minsalud.gob.bo/Reportes_Dinamicos/Menu_rep_dinamicos.aspx",updated_to="2024-12-21",path=r"\\10.0.0.9\spim\SNIS\Vigilancia Epidemiologica\04 Otras Infecciones")
#     print(x)
...
Executor_D_BO_000000173 = D_BO_000000173
Robot = D_BO_000000173
