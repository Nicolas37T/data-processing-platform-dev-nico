...
class D_BO_000000388(Download_Base):

    def get_file_url(self, main_url, updated_to, key_words = "deflactor gasto",format='%Y-%m-%d'):
        """
...
Executor_D_BO_000000388 = D_BO_000000388
Robot = D_BO_000000388
