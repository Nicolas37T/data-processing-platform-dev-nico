...
class D_BO_000000312(ASFI):
    ...
    def get_file_url(self, main_url, updated_to,format='%Y-%m-%d'):
        ...
        files_urls = super().get_file_url_main(main_url=main_url,updated_to=updated_to,SECTION=r"captaciones",KEY_WORDS=r"estratificacion.*dep")
        return files_urls
...
Executor_D_BO_000000312 = D_BO_000000312
Robot = D_BO_000000312
