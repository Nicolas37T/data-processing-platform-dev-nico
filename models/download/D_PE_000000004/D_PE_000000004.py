...
class D_PE_000000004(Download_Base):
    ...
    def check_new_data(self, main_url, updated_to,path,key_words, format='%Y-%m-%d'):
        ...
        title2_xpath = '//div[@class="tip-texto"]/p' 
        ...
        try:
            with sync_playwright() as pl:
                ...
                title2 = container.locator(title2_xpath).inner_text()
...
Executor_D_PE_000000004 = D_PE_000000004
Robot = D_PE_000000004
