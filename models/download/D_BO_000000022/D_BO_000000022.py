...
import pandas as pd
from models.download.tools.download_tools import format_date, delete_hidden_sheets,last_day_month,get_date_method_1
from models.conversion.tools.conversion_tools import search_key_words
from models.download.Download_Base import Download_Base

class D_BO_000000022(Download_Base):

    def get_file_url(self, main_url, updated_to, key_words="indice gas", format='%Y-%m-%d'):
        """
        ...
        with sync_playwright() as pl:
            ...
            try:
                ...
                files_link_searched = [link.get_attribute(
                    'href') for link in elements if search_key_words(text=link.inner_text(),key_words=key_words) ]
...
#     robot = D_BO_000000022()
#     # x = robot.get_file_url(main_url="https://www.ine.gob.bo/index.php/estadisticas-economicas/hidrocarburos-mineria/hidrocarburo-cuadros-estadisticos/",updated_to="2023-9-21")
#     # print(x)
#     y = robot.compare_files(files_paths=[{"tmp_path": r"C:\Users\Kevin Padilla\Downloads\8. Bolivia - Indice de Volumen y Variaciones de Producción de Petroleo y Gas Natural segun Año y Mes 1990 - 2024.xlsx"}],updated_to="2023-01-21")
#     print(y)

Executor_D_BO_000000022 = D_BO_000000022
Robot = D_BO_000000022
