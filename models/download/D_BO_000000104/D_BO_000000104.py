...
class D_BO_000000104(BCB_Boletin_Mensual):

    def get_file_url(self, main_url, updated_to, key_words = "liquidez desagregado",format='%Y-%m-%d'):
        """
...
Executor_D_BO_000000104 = D_BO_000000104
Robot = D_BO_000000104
