...
class D_BO_000000095(BCB_Sector_Monetario):

    def get_file_url(self, main_url, updated_to, key_words = "agregados monetarios",format='%Y-%m-%d'):
        """
...
Executor_D_BO_000000095 = D_BO_000000095
Robot = D_BO_000000095
