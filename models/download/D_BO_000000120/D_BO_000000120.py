...
class D_BO_000000120(BCB_Boletin_Mensual):

    def get_file_url(self, main_url, updated_to, key_words = "cooperativas",format='%Y-%m-%d'):
        """
...
Executor_D_BO_000000120 = D_BO_000000120
Robot = D_BO_000000120
