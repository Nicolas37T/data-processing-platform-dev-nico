...
class D_BO_000000515(BCB_Boletin_Mensual):

    def get_file_url(self, main_url, updated_to, key_words = "3.02 bancario economicos",format='%Y-%m-%d'):
        """
...
Executor_D_BO_000000515 = D_BO_000000515
Robot = D_BO_000000515
