...
class D_BO_000000144(BCB_Boletin_Mensual):

    def get_file_url(self, main_url, updated_to, key_words = "impuesto financier",format='%Y-%m-%d'):
        """
    ...
    def compare_files(self, files_paths, updated_to, format='%Y-%m-%d'):
        ...
        for file in files_paths:
            ...
            months = [re.search(re_month, str(value),re.IGNORECASE) for index,value in enumerate(df_new_file[df_new_file.columns[1]]) if re.search(re_month, str(value),re.IGNORECASE)]
...
#     robot = D_BO_000000144()
#     # x = robot.get_file_url(main_url="https://www.bcb.gob.bo/?q=pub_boletin-estadistico",updated_to="2023-10-21")
#     # print(len(x))
#     # print(x)
#     files = [{'download_url': 'https://www.bcb.gob.bo/webdocs/publicacionesbcb/2024/04/10/01.01P.xlsx', 'tmp_path': r"\\10.0.0.9\SPIM\BCB\01-Informacion Estadistica\03-Sector Bancario y Financiero\04-Depositos\11-Certificados de Depósito y Letras del Tesoro General de la Nación\tmp\2024-05-07_15141104.15.xlsx"}]
#     y = robot.compare_files(files_paths=files,updated_to="2023-01-21")
#     print(y)

Executor_D_BO_000000144 = D_BO_000000144
Robot = D_BO_000000144
