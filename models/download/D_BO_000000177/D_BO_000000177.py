...
#     robot = D_BO_000000177()
#     x = robot.get_data(main_url="https://estadisticas.minsalud.gob.bo/Reportes_Dinamicos/Menu_rep_dinamicos.aspx",updated_to="2024-12-21",path=r"\\10.0.0.9\spim\SNIS\Vigilancia Epidemiologica\08 Salud Sexual y Reproductiva")
#     print(x)
...
Executor_D_BO_000000177 = D_BO_000000177
Robot = D_BO_000000177
