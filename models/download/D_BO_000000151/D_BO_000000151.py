...
import pandas as pd
from models.download.tools.download_tools import search_key_words, format_date,last_day_month, delete_hidden_sheets
from models.download.Download_Base import Download_Base

class D_BO_000000151(Download_Base):

    def get_file_url(self, main_url, updated_to, key_words = "participacion pib corrientes actividad",format='%Y-%m-%d'):
        """
...
#     robot = D_BO_000000151()
#     x = robot.get_file_url(main_url="https://www.ine.gob.bo/index.php/estadisticas-economicas/pib-y-cuentas-nacionales/producto-interno-bruto-trimestral/producto-interno-bruto-trimestral-intro/#1604584724125-615aec14-e917",updated_to="2023-10-21")
#     print(len(x))
#     print(x)
#     # files = [{'download_url': 'https://www.bcb.gob.bo/webdocs/publicacionesbcb/2024/04/10/01.01P.xlsx', 'tmp_path': r"C:\Users\Kevin Padilla\Downloads\Emp - 2024_04_1_Nal - Serie_Historica.xlsx"}]
#     # y = robot.compare_files(files_paths=files,updated_to="2023-01-21")
#     # print(y)

Executor_D_BO_000000151 = D_BO_000000151
Robot = D_BO_000000151
