...
class D_BO_000000016(Download_Base):
...
#     robot = D_BO_000000016()
#     # x = robot.get_file_url(main_url="https://www.ine.gob.bo/index.php/ciudades-y-conurbaciones/",updated_to="2023-9-21")
#     # print(x)
#     y = robot.compare_files(files_paths=[{"tmp_path": r"C:\Users\Kevin Padilla\Downloads\Ciu-2024_03_3_Ciudad Capital y Conurbacion_Ind_Div_Var_Men_12_Mes_Acum_Base_2016.xlsx"}],updated_to="2024-01-21")

Executor_D_BO_000000016 = D_BO_000000016
Robot = D_BO_000000016
