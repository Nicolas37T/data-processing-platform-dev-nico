...
class D_BO_000000508(BCB_Boletin_Mensual):

    def get_file_url(self, main_url, updated_to, key_words = "tradicionales volumen",format='%Y-%m-%d'):
        """
...
Executor_D_BO_000000508 = D_BO_000000508
Robot = D_BO_000000508
