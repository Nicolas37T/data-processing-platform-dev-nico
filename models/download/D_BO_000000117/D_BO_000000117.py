...
class D_BO_000000117(BCB_Boletin_Mensual):

    def get_file_url(self, main_url, updated_to, key_words = "bancos especializados",format='%Y-%m-%d'):
        """
        ...
        files_urls = super().get_file_url_main(main_url=main_url,updated_to=updated_to, key_words=key_words, exact=True)
        return files_urls
...
#     robot = D_BO_000000117()
#     # x = robot.get_file_url(main_url="https://www.bcb.gob.bo/?q=pub_boletin-estadistico",updated_to="2023-10-21")
#     # print(len(x))
#     # print(x)
#     files = [{'download_url': 'https://www.bcb.gob.bo/webdocs/publicacionesbcb/2024/04/10/01.01P.xlsx', 'tmp_path': "\\\\10.0.0.9\\SPIM\\BCB\\01-Informacion Estadistica\\03-Sector Bancario y Financiero\\01-Balances Consolidados\\12-De Bancos Especializados, Pasivo\\tmp\\2024-05-07_10061802.09P.xlsx"}]
#     y = robot.compare_files(files_paths=files,updated_to="2023-01-21")
#     print(y)

Executor_D_BO_000000117 = D_BO_000000117
Robot = D_BO_000000117
