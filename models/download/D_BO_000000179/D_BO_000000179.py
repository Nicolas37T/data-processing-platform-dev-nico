...
class D_BO_000000179(SNIS):
    ...
    def get_data(self, main_url,path, updated_to,format='%Y-%m-%d'):
        ...
        variable={
            "code":"15",
            "key_words":"eventos notificacion i"
            }
        form_code='302'
...
#     robot = D_BO_000000179()
#     x = robot.get_data(main_url="https://estadisticas.minsalud.gob.bo/Reportes_Dinamicos/Menu_rep_dinamicos.aspx",updated_to="2024-12-21",path=r"\\10.0.0.9\spim\SNIS\Vigilancia Epidemiologica\10 Eventos - Notificacion Inmendiata Parte I")
#     print(x)
#     # y = robot.compare_files(file_path=r"\\10.0.0.9\spim\SNIS\Vigilancia Epidemiologica\10 Eventos - Notificacion Inmendiata Parte I\2022\ch_eventos notificacion i.xls", year=2022)
#     # print(y)

Executor_D_BO_000000179 = D_BO_000000179
Robot = D_BO_000000179
