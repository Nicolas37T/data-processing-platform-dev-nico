...
class D_BO_000000390(Download_Base):

    def get_file_url(self, main_url, updated_to, key_words = "tarija pib constantes",format='%Y-%m-%d'):
        """
...
Executor_D_BO_000000390 = D_BO_000000390
Robot = D_BO_000000390
