...
class D_BO_000000387(Download_Base):

    def get_file_url(self, main_url, updated_to, key_words = "pib participacion gasto",format='%Y-%m-%d'):
        """
...
Executor_D_BO_000000387 = D_BO_000000387
Robot = D_BO_000000387
