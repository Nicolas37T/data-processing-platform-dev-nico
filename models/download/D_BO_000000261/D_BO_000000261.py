...
class D_BO_000000261(Download_Base):
        ...
        try:
            ...
            for year in range(updated_to.year,today.year+1):
                for month in months:
                    ...
                    if not len(files):
                        continue
                    file = [f for f in files if "PM_PSV" in f["filename"]][0]
...
#     robot = D_BO_000000261()
#     x = robot.get_file_url(main_url="http://senamhi.gob.bo/index.php/pcpn",updated_to="2023-2-21")
#     print(len(x))
#     print(x)
...
Executor_D_BO_000000261 = D_BO_000000261
Robot = D_BO_000000261
