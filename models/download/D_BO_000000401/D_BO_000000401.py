...
class D_BO_000000401(Download_Base):

    def get_file_url(self, main_url, updated_to, key_words = "la paz pib corrientes",format='%Y-%m-%d'):
        """
...
Executor_D_BO_000000401 = D_BO_000000401
Robot = D_BO_000000401
