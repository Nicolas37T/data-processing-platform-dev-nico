...
class D_BO_000000272(Download_Base):
    ...
    def check_new_data(self, main_url, updated_to,path,key_words, format='%Y-%m-%d'):
        ...
        with sync_playwright() as pl:
            ...
            try:
                ...
                date = re.search(re_date, page.query_selector('//div[@class="ranking-update-dates_dateItem__t9Z__"]').inner_text(), re.IGNORECASE).group(1,2,3)
                year = date[2]
...
Executor_D_BO_000000272 = D_BO_000000272
Robot = D_BO_000000272
