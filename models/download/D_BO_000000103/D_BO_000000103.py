...
class D_BO_000000103(BCB_Boletin_Mensual):

    def get_file_url(self, main_url, updated_to, key_words = "1.03 origen liquidez",format='%Y-%m-%d'):
        """
...
Executor_D_BO_000000103 = D_BO_000000103
Robot = D_BO_000000103
