...
class D_BO_000000175(SNIS):
    ...
    def get_data(self, main_url,path, updated_to,format='%Y-%m-%d'):
        ...
        variable={
            "code":"08",
            "key_words":"violencia accidentes"
            }
        form_code='302'
...
#     robot = D_BO_000000175()
#     x = robot.get_data(main_url="https://estadisticas.minsalud.gob.bo/Reportes_Dinamicos/Menu_rep_dinamicos.aspx",updated_to="2024-12-21",path=r"\\10.0.0.9\spim\SNIS\Vigilancia Epidemiologica\06 Violencia, Hechos de Transito y Accidentes")
#     print(x)

Executor_D_BO_000000175 = D_BO_000000175
Robot = D_BO_000000175
