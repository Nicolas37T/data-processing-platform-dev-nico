...
class D_BO_000000403(Download_Base):

    def get_file_url(self, main_url, updated_to, key_words = "chuquisaca pib corrientes",format='%Y-%m-%d'):
        """
...
Executor_D_BO_000000403 = D_BO_000000403
Robot = D_BO_000000403
