...
#     robot = D_BO_000000204()
#     x = robot.get_data(main_url="https://estadisticas.minsalud.gob.bo/Reportes_Dinamicos/Menu_rep_dinamicos.aspx",updated_to="2024-12-21",path=r"\\10.0.0.9\spim\SNIS\Produccion de Servicios\25 Chagas Viviendas")
#     print(x)
...
Executor_D_BO_000000204 = D_BO_000000204
Robot = D_BO_000000204
