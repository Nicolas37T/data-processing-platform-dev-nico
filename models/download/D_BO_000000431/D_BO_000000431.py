...
class D_BO_000000431(Download_Base):

    def verify_download(self, main_url, updated_to, path, key_words = "4.04.01.07",format='%Y-%m-%d'):
        """
    ...
    def compare_files(self, files_paths, updated_to, format='%Y-%m-%d'):
        ...
        for file in files_paths: 
            ...
            sub_set =  df_new_file[df_new_file.iloc[:, 0]=="DEPARTAMENTO Y CAMPO"].values.tolist()
...
Executor_D_BO_000000431 = D_BO_000000431
Robot = D_BO_000000431
