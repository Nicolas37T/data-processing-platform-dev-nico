...
class D_BO_000000399(Download_Base):

    def get_file_url(self, main_url, updated_to, key_words = "oruro pib corrientes",format='%Y-%m-%d'):
        """
...
Executor_D_BO_000000399 = D_BO_000000399
Robot = D_BO_000000399
