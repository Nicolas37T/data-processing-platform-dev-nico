...
class D_BO_000000040(Download_Base):
            ...
            try:
                ...
                for attempt in range(1, max_retries+1):
                    try:
                        ...
                        page.wait_for_selector('//*[@id="quicktabs-tabpage-resultado_de_subastas_letras_del-1"]//div[@class="view-content"]/div', state="attached",timeout=10*1000)
                        break
                    except Exception:
                ...
                files_rows = page.query_selector_all('//*[@id="quicktabs-tabpage-resultado_de_subastas_letras_del-1"]//div[@class="view-content"]/div')
...
#     robot = D_BO_000000040()
#     x = robot.get_file_url(main_url="https://www.bcb.gob.bo/?q=content/resultado-de-subastas-letras-del-bcb-12",updated_to="2023-9-21")
#     print(x)
#     # y = robot.compare_files(files_paths=[{"tmp_path": r"C:\Users\Kevin Padilla\Downloads\LB-16-2024 Desmat_TR..pdf"}],updated_to="2023-01-21")
#     # print(y)

Executor_D_BO_000000040 = D_BO_000000040
Robot = D_BO_000000040
