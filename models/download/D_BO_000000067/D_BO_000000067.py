...
class D_BO_000000067(CNDC):

    def get_file_url(self, main_url, updated_to,key_words="poder calor" , format='%Y-%m-%d'):
        """
    ...
    def compare_files(self, files_paths, updated_to, format='%Y-%m-%d'):
        ...
        for file in files_paths:
            ...
            date = [re.search(re_date, str(value)) for index,value in enumerate(sub_set) if re.search(re_date, str(value)) and  pd.notna(df_new_file[df_new_file.columns[1]].iloc[index])]
            if len(date):
                date = date[-1]
...
#     robot = D_BO_000000067()
#     # x = robot.get_file_url(main_url="https://www.cndc.bo/estadisticas/anual.php",updated_to="2023-11-21")
#     # print(x)
#     y = robot.compare_files(files_paths=[{"tmp_path": r"C:\Users\Kevin Padilla\Downloads\pcalorifico_2023.zip"}],updated_to="2023-01-21")
#     print(y)

Executor_D_BO_000000067 = D_BO_000000067
Robot = D_BO_000000067
