...
class D_BO_000000153(Download_Base):

    def get_file_url(self, main_url, updated_to, key_words = "pib corrientes gasto",format='%Y-%m-%d'):
        """
...
Executor_D_BO_000000153 = D_BO_000000153
Robot = D_BO_000000153
