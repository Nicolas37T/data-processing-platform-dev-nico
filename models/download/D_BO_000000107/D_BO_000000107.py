...
class D_BO_000000107(BCB_Boletin_Mensual):

    def get_file_url(self, main_url, updated_to, key_words = "sistema financiero",format='%Y-%m-%d'):
        """
...
Executor_D_BO_000000107 = D_BO_000000107
Robot = D_BO_000000107
