...
class D_BO_000000443(Download_Base):

    def get_file_url(self, main_url, updated_to, key_words = "salida fronterizo",format='%Y-%m-%d'):
        """
...
Executor_D_BO_000000443 = D_BO_000000443
Robot = D_BO_000000443
