...
class D_BO_000000517(BCB_Boletin_Mensual):

    def get_file_url(self, main_url, updated_to, key_words = "entidades financieras sectores",format='%Y-%m-%d'):
        """
...
#     robot = Executor_D_BO_000000517()
    # x = robot.get_file_url(main_url="https://www.bcb.gob.bo/?q=pub_boletin-estadistico",updated_to="2023-12-31")
    # print(len(x))
    # print(x)
    # files = [{'download_url': 'https://www.bcb.gob.bo/webdocs/publicacionesbcb/2024/04/10/01.01P.xlsx', 'tmp_path': r"D:\DATAX\data-processing-platform\local_downloads\BCB\01-Informacion Estadistica\04-Sector Externo\04-Exportaciones\09-De Minerales Volumen\tmp\2024-08-20_19552909.05.xlsx"}]
    # y = robot.compare_files(files_paths=files,updated_to="2023-01-21")
    # print(y)

Executor_D_BO_000000517 = D_BO_000000517
Robot = D_BO_000000517
