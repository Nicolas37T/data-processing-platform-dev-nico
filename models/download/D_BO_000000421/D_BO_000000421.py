...
class D_BO_000000421(Download_Base):

    def get_file_url(self, main_url, updated_to, key_words = "bolivia departamento red",format='%Y-%m-%d'):
        """
...
Executor_D_BO_000000421 = D_BO_000000421
Robot = D_BO_000000421
