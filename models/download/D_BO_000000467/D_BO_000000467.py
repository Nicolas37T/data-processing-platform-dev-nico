...
class D_BO_000000467(Download_Base):
...
if __name__ == "__main__":
    robot = Executor_D_BO_000000467()
    x =robot.get_file_url(main_url="https://api-cepalstat.cepal.org/cepalstat/api/v1/portal/cepalstat/updates?top=5000&app=portal&lang=es",updated_to='2019-05-03')
    print(len(x))
    print(x)
...
Executor_D_BO_000000467 = D_BO_000000467
Robot = D_BO_000000467
