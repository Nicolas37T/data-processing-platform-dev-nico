...
class D_CL_000000001(Download_Base):
    ...
    def verify_download(self, main_url, updated_to, path,format='%Y-%m-%d'):
        ...
        year_select_xpath = '#cbFechaDiaria'
        ...
        try:
            with sync_playwright() as pl:
                ...
                for year in year_options:
                    ...
                    month = m if (m:=month_abr_to_number(last_date[1])) else month_to_number(last_date[1])

                    last_date_formatted = format_date(f'{last_date[2]}-{month}-{last_date[0]}')
...
Executor_D_CL_000000001 = D_CL_000000001
Robot = D_CL_000000001
