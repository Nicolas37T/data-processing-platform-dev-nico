...
class D_BO_000000075(CNDC):

    def get_file_url(self, main_url, updated_to,key_words="precio gas" , format='%Y-%m-%d'):
        """
...
Executor_D_BO_000000075 = D_BO_000000075
Robot = D_BO_000000075
