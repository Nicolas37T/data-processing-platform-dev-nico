...
class D_BO_000000034(Download_Base):
...
#     robot = D_BO_000000034()
#     # x = robot.get_file_url(main_url="https://www.bcb.gob.bo/?q=tasas_interes",updated_to="2023-9-21")
#     # print(x)
#     y = robot.compare_files(files_paths=[{"tmp_path": r"C:\Users\Kevin Padilla\Downloads\28PAANUAL_0.pdf"}],updated_to="2023-01-21")
#     print(y)

Executor_D_BO_000000034 = D_BO_000000034
Robot = D_BO_000000034
