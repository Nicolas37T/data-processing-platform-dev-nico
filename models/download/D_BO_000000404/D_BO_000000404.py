...
class D_BO_000000404(Download_Base):

    def get_file_url(self, main_url, updated_to, key_words = "beni pib constantes",format='%Y-%m-%d'):
        """
...
Executor_D_BO_000000404 = D_BO_000000404
Robot = D_BO_000000404
