...
class D_BO_000000450(Download_Base):

    def get_file_url(self, main_url, updated_to, key_words = "extranjeros gasto",format='%Y-%m-%d'):
        """
    ...
    def compare_files(self, files_paths, updated_to, format='%Y-%m-%d'):
        ...
        for file in files_paths: 
            ...
            sub_set =  df_new_file[df_new_file.iloc[:, 0]=="TIPO DE GASTO"].values.tolist()
...
Executor_D_BO_000000450 = D_BO_000000450
Robot = D_BO_000000450
