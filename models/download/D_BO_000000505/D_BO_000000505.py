...
class D_BO_000000505(BCB_Boletin_Mensual):

    def get_file_url(self, main_url, updated_to, key_words = "9.06 minerales valor unitario",format='%Y-%m-%d'):
        """
    ...
    def compare_files(self, files_paths, updated_to, format='%Y-%m-%d'):
        ...
        for file in files_paths:
            ...
            years = df_new_file[df_new_file.columns[0]].str.extract(re_year,flags=re.IGNORECASE,expand=False).dropna()
...
Executor_D_BO_000000505 = D_BO_000000505
Robot = D_BO_000000505
