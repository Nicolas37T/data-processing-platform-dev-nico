...
class D_BO_000000539(Download_Base):
    ...
    def get_file_url(self, main_url, updated_to, format='%Y-%m-%d'):
        ...
        with sync_playwright() as pl:
            ...
            # Xpaths
            seccion_button_xpath = '#quicktabs-tab-resultado_de_subastas_bonos_del_-0'
            rows_xpath = '//*[@id="quicktabs-tabpage-resultado_de_subastas_bonos_del_-0"]//div[@class="view-content"]/div'
            next_page_button_xpath = '//*[@id="quicktabs-container-resultado_de_subastas_bonos_del_"]//li[@class="pager-next"]/a'
...
#     robot = Executor_D_BO_000000539()
    ...
    # print(x)
    # y = robot.compare_files(files_paths=[{"tmp_path": r"C:\Users\Kevin Padilla\Downloads\BB UFV-49-2024 Desmat_TR..pdf"}],updated_to="2015-01-21")
    # print(y)

Executor_D_BO_000000539 = D_BO_000000539
Robot = D_BO_000000539
