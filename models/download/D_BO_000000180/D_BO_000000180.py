...
class D_BO_000000180(SNIS):
    ...
    def get_data(self, main_url,path, updated_to,format='%Y-%m-%d'):
        ...
        variable={
            "code":"16",
            "key_words":"eventos notificacion ii"
            }
        form_code='302'
...
#     robot = D_BO_000000180()
#     x = robot.get_data(main_url="https://estadisticas.minsalud.gob.bo/Reportes_Dinamicos/Menu_rep_dinamicos.aspx",updated_to="2024-12-21",path=r"\\10.0.0.9\spim\SNIS\Vigilancia Epidemiologica\11 Eventos - Notificacion Inmendiata Parte II")
#     print(x)
...
Executor_D_BO_000000180 = D_BO_000000180
Robot = D_BO_000000180
