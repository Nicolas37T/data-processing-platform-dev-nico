...
class D_BO_000000081(BCB_Boletin_Mensual):

    def get_file_url(self, main_url, updated_to, key_words = "caja ahorros",format='%Y-%m-%d'):
        """
...
Executor_D_BO_000000081 = D_BO_000000081
Robot = D_BO_000000081
