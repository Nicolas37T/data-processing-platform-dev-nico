...
class D_BO_000000062(CNDC):

    def get_file_url(self, main_url, updated_to,key_words="retiro nodo" , format='%Y-%m-%d'):
        """
...
Executor_D_BO_000000062 = D_BO_000000062
Robot = D_BO_000000062
