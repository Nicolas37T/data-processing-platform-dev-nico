...
class D_BO_000000085(Download_Base):

    def get_file_url(self, main_url, updated_to, key_words = "tasa real",format='%Y-%m-%d'):
        """
...
Executor_D_BO_000000085 = D_BO_000000085
Robot = D_BO_000000085
