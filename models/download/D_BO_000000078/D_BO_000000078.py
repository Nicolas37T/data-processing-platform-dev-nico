...
class D_BO_000000078(BCB_Sector_Externo):

    def get_file_url(self, main_url, updated_to, key_words = "bolsin indicadores",format='%Y-%m-%d'):
        """
    ...
    def compare_files(self, files_paths, updated_to, format='%Y-%m-%d'):
        ...
        for file in files_paths:
            ...
            months = [re.search(re_month, str(value),re.IGNORECASE) for index,value in enumerate(sub_set) if re.search(re_month, str(value),re.IGNORECASE) and  pd.notna(df_new_file[df_new_file.columns[2]].iloc[index])]
...
#     robot = D_BO_000000078()
#     # x = robot.get_file_url(main_url="https://www.bcb.gob.bo/?q=pub_boletin-mensual",updated_to="2023-10-21")
#     # print(len(x))
#     files_paths = [{'download_url': 'https://www.bcb.gob.bo/webdocs/publicacionesbcb/2024/04/57/26.xlsx', 'tmp_path': '\\\\10.0.0.9\\spim\\BCB\\01-Informacion Estadistica\\04-Sector Externo\\07-Tipos de cambio y cotizaciones de monedas\\01-Bolsín Principales Indicadores\\tmp\\2024-04-26_09225526.xlsx'}, {'download_url': 'https://www.bcb.gob.bo/webdocs/publicacionesbcb/2024/04/52/26.xlsx', 'tmp_path': '\\\\10.0.0.9\\spim\\BCB\\01-Informacion Estadistica\\04-Sector Externo\\07-Tipos de cambio y cotizaciones de monedas\\01-Bolsín Principales Indicadores\\tmp\\2024-04-26_09230026.xlsx'}]
#     y = robot.compare_files(files_paths=files_paths,updated_to="2023-01-21")
#     print(y)

Executor_D_BO_000000078 = D_BO_000000078
Robot = D_BO_000000078
