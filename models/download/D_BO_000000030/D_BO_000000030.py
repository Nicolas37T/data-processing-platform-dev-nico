...
class D_BO_000000030(Download_Base):
    ...
    def get_file_url(self, main_url, updated_to, format='%Y-%m-%d'):
        ...
        with sync_playwright() as pl:
            ...
            try:
                ...
                monthly_columns = [link.query_selector_all('//a') for link in files_urls[4:6]]
                ...
                monthly_columns = [[column[i] for i in index_searched]for column in monthly_columns]
                monthly_files_urls = [link for list in monthly_columns for link in list]
                monthly_files_urls = [link.get_attribute("href") for link in monthly_files_urls]
                
                print("Found files matching the criteria.")
                return monthly_files_urls
...
#     robot = D_BO_000000030()
#     # x = robot.get_file_url(main_url="https://www.bcb.gob.bo/?q=tasas_interes",updated_to="2023-9-21")
#     # print(x)
#     y = robot.compare_files(files_paths=[{"tmp_path": r"C:\Users\Kevin Padilla\Downloads\30 AC M 2024.xlsx"},{"tmp_path": r"C:\Users\Kevin Padilla\Downloads\30 AC M 2024.pdf"}],updated_to="2023-01-21")
#     print(y)

Executor_D_BO_000000030 = D_BO_000000030
Robot = D_BO_000000030
