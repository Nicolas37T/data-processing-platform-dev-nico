...
class D_BO_000000018(Download_Base):

    def get_file_url(self, main_url, updated_to, key_words="venta cemento", format='%Y-%m-%d'):
        """
...
#     # print(x)
#     y = robot.compare_files(files_paths=[{"tmp_path": r"C:\Users\Kevin Padilla\Downloads\2. Bolivia - Ventas de Cemento por Departamento segun Año y Mes 1991 - 2024.xlsx"}],updated_to="2023-01-21")
#     print(y)

Executor_D_BO_000000018 = D_BO_000000018
Robot = D_BO_000000018
