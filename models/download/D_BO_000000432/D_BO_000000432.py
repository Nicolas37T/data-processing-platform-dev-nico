...
class D_BO_000000432(Download_Base):

    def verify_download(self, main_url, updated_to, path, key_words = "4.04.01.06",format='%Y-%m-%d'):
        """
...
Executor_D_BO_000000432 = D_BO_000000432
Robot = D_BO_000000432
