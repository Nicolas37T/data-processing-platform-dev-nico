...
class D_BO_000000269(BCB_Boletin_Mensual):

    def get_file_url(self, main_url, updated_to, key_words = "volumen valor exportaciones",format='%Y-%m-%d'):
        """
        ...
        for file in files_paths:
            ...
            for column in dataframe_to_look.columns:
                for index, value in dataframe_to_look[column].items():
                    ...
                    year_value = re.search(re_year,value_str)
                    month_value = re.search(re_month,value_str)
                    if year_value :
            ...
            now = datetime.now()
            years = [ y_f for y in years if (y_f:=int(y.group(1))) <= now.year]
...
#     robot = D_BO_000000269()
#     # x = robot.get_file_url(main_url="https://www.bcb.gob.bo/?q=pub_boletin-mensual",updated_to="2024-1-21")
#     # print(len(x))
#     # print(x)
#     files = [{'download_url': 'https://www.bcb.gob.bo/webdocs/publicacionesbcb/2023/12/49/13.pdf', 'tmp_path': '\\\\10.0.0.9\\spim\\BCB\\01-Informacion Estadistica\\04-Sector Externo\\04-Exportaciones\\01-Volumen y valor\\tmp\\2024-05-24_17384113.pdf'}, {'download_url': 'https://www.bcb.gob.bo/webdocs/publicacionesbcb/2023/12/49/13.xlsx', 'tmp_path': '\\\\10.0.0.9\\spim\\BCB\\01-Informacion Estadistica\\04-Sector Externo\\04-Exportaciones\\01-Volumen y valor\\tmp\\2024-05-24_17384413.xlsx'}]
#     y = robot.compare_files(files_paths=files,updated_to="2023-01-21")
#     print(y)

Executor_D_BO_000000269 = D_BO_000000269
Robot = D_BO_000000269
