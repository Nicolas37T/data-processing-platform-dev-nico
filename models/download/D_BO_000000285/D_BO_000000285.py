...
if __name__ == "__main__":
    robot = Executor_D_BO_000000285()
    x = robot.get_file_url(main_url="https://www.asfi.gob.bo/index.php/entidades-financieras-de-vivienda.html",updated_to="2023-5-21")
    print(len(x))
    print(x)
...
Executor_D_BO_000000285 = D_BO_000000285
Robot = D_BO_000000285
