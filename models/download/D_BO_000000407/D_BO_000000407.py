...
class D_BO_000000407(Download_Base):

    def get_file_url(self, main_url, updated_to, key_words = "cochabamba pib corrientes",format='%Y-%m-%d'):
        """
...
Executor_D_BO_000000407 = D_BO_000000407
Robot = D_BO_000000407
