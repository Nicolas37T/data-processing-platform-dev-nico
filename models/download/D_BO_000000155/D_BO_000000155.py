...
class D_BO_000000155(Download_Base):

    def get_file_url(self, main_url, updated_to, key_words = "oferta demanda corrientes",format='%Y-%m-%d'):
        """
...
Executor_D_BO_000000155 = D_BO_000000155
Robot = D_BO_000000155
