...
class D_BO_000000392(Download_Base):

    def get_file_url(self, main_url, updated_to, key_words = "santa cruz pib constantes",format='%Y-%m-%d'):
        """
...
Executor_D_BO_000000392 = D_BO_000000392
Robot = D_BO_000000392
