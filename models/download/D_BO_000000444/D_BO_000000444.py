...
class D_BO_000000444(Download_Base):

    def get_file_url(self, main_url, updated_to, key_words = "salida nacionalidad",format='%Y-%m-%d'):
        """
...
Executor_D_BO_000000444 = D_BO_000000444
Robot = D_BO_000000444
