...
class D_BO_000000125(BCB_Boletin_Mensual):

    def get_file_url(self, main_url, updated_to, key_words = "privado sectores bancos",format='%Y-%m-%d'):
        """
...
Executor_D_BO_000000125 = D_BO_000000125
Robot = D_BO_000000125
