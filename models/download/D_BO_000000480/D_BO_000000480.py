...
class D_BO_000000480(CNDC):

    def get_file_url(self, main_url, updated_to, key_words="genera 12 meses", format='%Y-%m-%d'):
        """
    ...
    def compare_files(self, files_paths, updated_to, format='%Y-%m-%d'):
        ...
        for file in files_paths:
            ...
            date = df_new_file[df_new_file.columns[0]].str.extract(re_date,flags=re.IGNORECASE).dropna().iloc[0]
            
            date_formated = format_date(date[0], "%d/%m/%Y")
...
#     robot = Executor_D_BO_000000480()
#     # x =robot.get_file_url(main_url="https://www.cndc.bo/estadisticas/index.php",updated_to='2024-08-06')
#     # print(len(x))
#     # print(x)
#     files = [{'download_url': 'https://www.bcb.gob.bo/webdocs/publicacionesbcb/2024/04/10/01.01P.xlsx', 'tmp_path': r"/opt/airflow/models/download/D_BO_000000480/gendia20240808.zip"}]
#     y = robot.compare_files(files_paths=files,updated_to="2024-08-09")
#     print(y)


Executor_D_BO_000000480 = D_BO_000000480
Robot = D_BO_000000480
