...
class D_BO_000000395(Download_Base):

    def get_file_url(self, main_url, updated_to, key_words = "potosi pib corrientes",format='%Y-%m-%d'):
        """
...
Executor_D_BO_000000395 = D_BO_000000395
Robot = D_BO_000000395
