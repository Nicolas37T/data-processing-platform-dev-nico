...
class D_BO_000000263(Download_Base):
        ...
        try:
            ...
            for year in range(updated_to.year,today.year+1):
                for month in months:
                    ...
                    filtered_files = [f for f in files if re.search(r'gestora',f['filename'],re.IGNORECASE)]
...
Executor_D_BO_000000263 = D_BO_000000263
Robot = D_BO_000000263
