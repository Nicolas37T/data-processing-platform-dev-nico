    ...
    def verify_download(self,main_url, updated_to, path, key_words="", format='%Y-%m-%d'):
        ...
        with sync_playwright() as pl:
            ...
            try:
                ...
                tab_1 = [item for item in page.locator(tab_1_xpath).all() if search_key_words(text=item.inner_text(),key_words="programa")]
                if not tab_1:
                ...
                while True:
                    ...
                    page.locator('#precmp-fecha-select').fill(updated_to.strftime(format="%Y-%m-%d"))
                    page.wait_for_timeout(3*1000)
