...
class D_BO_000000426(Download_Base):

    def get_file_url(self, main_url, updated_to, key_words = "potosi red rodadura",format='%Y-%m-%d'):
        """
...
#     # print(len(x))
#     # print(x)
    files = [{'download_url': 'https://nube.ine.gob.bo/index.php/s/PnEqp7IopHEJDBu/download', 'tmp_path': '/media/spim_10009/INE/Estadisticas Economicas/Construcción/Longitud de Caminos/Longitud de Caminos según Red y Superficie de Rodadura/tmp/2024-07-11_101809download.xlsx'}]
    y = robot.compare_files(files_paths=files,updated_to="2022-01-21")
    print(y)

Executor_D_BO_000000426 = D_BO_000000426
Robot = D_BO_000000426
