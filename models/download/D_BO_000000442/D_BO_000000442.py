...
class D_BO_000000442(Download_Base):

    def get_file_url(self, main_url, updated_to, key_words = "salida aeropuerto",format='%Y-%m-%d'):
        """
...
Executor_D_BO_000000442 = D_BO_000000442
Robot = D_BO_000000442
