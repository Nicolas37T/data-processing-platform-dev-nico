...
class D_BO_000000169(Download_Base):

    def get_file_url(self, main_url, updated_to, key_words = "remuneracion nominal ocupacional 1996",format='%Y-%m-%d'):
        """
...
Executor_D_BO_000000169 = D_BO_000000169
Robot = D_BO_000000169
