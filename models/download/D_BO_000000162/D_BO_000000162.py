...
class D_BO_000000162(Download_Base):

    def get_file_url(self, main_url, updated_to, key_words = "indice salario nominal actividad",format='%Y-%m-%d'):
        """
...
Executor_D_BO_000000162 = D_BO_000000162
Robot = D_BO_000000162
