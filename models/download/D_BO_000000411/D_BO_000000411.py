...
import pandas as pd
from models.download.tools.download_tools import search_key_words, format_date, delete_hidden_sheets, last_day_month
from models.download.Download_Base import Download_Base

class D_BO_000000411(Download_Base):

    def get_file_url(self, main_url, updated_to, key_words = "linea movil",format='%Y-%m-%d'):
        """
...
Executor_D_BO_000000411 = D_BO_000000411
Robot = D_BO_000000411
