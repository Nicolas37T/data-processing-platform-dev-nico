...
class D_CL_000000005(Download_Base):
    ...
    def verify_download(self, main_url, updated_to, path,format='%Y-%m-%d'):
        ...
        try:
            with sync_playwright() as pl:
                ...
                page.wait_for_selector(copper_button_xpath,state='visible')
                page.locator(copper_button_xpath).click()
...
Executor_D_CL_000000005 = D_CL_000000005
Robot = D_CL_000000005
