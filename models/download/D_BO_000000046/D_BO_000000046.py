...
class D_BO_000000046(Download_Base):

    def get_file_url(self, main_url, updated_to, format='%Y-%m-%d', key_words="variacion similar"):
        """
...
Executor_D_BO_000000046 = D_BO_000000046
Robot = D_BO_000000046
