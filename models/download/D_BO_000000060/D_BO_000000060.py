...
class D_BO_000000060(CNDC):

    def get_file_url(self, main_url, updated_to,key_words="inyecciones nodos" , format='%Y-%m-%d'):
        """
...
Executor_D_BO_000000060 = D_BO_000000060
Robot = D_BO_000000060
