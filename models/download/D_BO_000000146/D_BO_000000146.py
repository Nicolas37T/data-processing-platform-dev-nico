...
class D_BO_000000146(Download_Base):

    def get_file_url(self, main_url, updated_to, key_words = "indice volumen 1990",format='%Y-%m-%d'):
        """
...
Executor_D_BO_000000146 = D_BO_000000146
Robot = D_BO_000000146
