...
class D_BO_000000264(Download_Base):
        ...
        try:
            ...
            for year in range(updated_to.year,today.year+1):
                for month in months:
                    ...
                    url = f"https://www.aps.gob.bo/?option=com_ajax&module=apsfilesdisplayer&method=getFiles&format=json&folder=webdocs___UNE___DP___Estadisticas___Prestaciones+y+Beneficios___Prestaciones+del+SIP___{year}___{month}&format=json"
                    ...
                    filtered_files = [f for f in files if re.search(r'provida',f['filename'],re.IGNORECASE)]
...
#     robot = D_BO_000000264()
#     # x = robot.get_file_url(main_url="http://senamhi.gob.bo/index.php/pcpn",updated_to="2023-5-21")
#     # print(len(x))
#     # print(x)
#     files = [{'download_url': 'https://www.bcb.gob.bo/webdocs/publicacionesbcb/2024/04/10/01.01P.xlsx', 'tmp_path': "\\\\10.0.0.9\\SPIM\\APS\\Pensiones-Estad.Mensuales\\Prestaciones y Beneficios\\Prestaciones del SIP\\Pago Pensiones Invalidez y Muerte - La Vitalicia\\tmp\\2024-05-27_103703MONTOS_PROVIDA_VITALICIA_202311.pdf"}]
#     y = robot.compare_files(files_paths=files,updated_to="2023-01-21")
#     print(y)

Executor_D_BO_000000264 = D_BO_000000264
Robot = D_BO_000000264
