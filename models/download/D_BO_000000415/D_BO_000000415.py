...
class D_BO_000000415(Download_Base):

    def get_file_url(self, main_url, updated_to, key_words = "produccion agricola",format='%Y-%m-%d'):
        """
...
Executor_D_BO_000000415 = D_BO_000000415
Robot = D_BO_000000415
