...
class D_BO_000000541(Download_Base):
    ...
    def check_new_data(self, main_url, updated_to,path,key_words, format='%Y-%m-%d'):
        ...
        with sync_playwright() as pl:
            ...
            title_xpath= '//div[@data-triami-bind="TableResponsive:1"]/table/caption'
            ...
            try:
                ...
                title = page.query_selector(title_xpath).inner_text()
...
#     robot = Executor_D_BO_000000541()
#     x =robot.check_new_data(main_url="https://www.global-rates.com/en/interest-rates/cme-term-sofr/",updated_to='2024-08-01', path=r"D:\DATAX\data-processing-platform\models\download\D_BO_000000541", key_words="tasa sofr")
#     print(len(x))
#     print(x)
...
Executor_D_BO_000000541 = D_BO_000000541
Robot = D_BO_000000541
