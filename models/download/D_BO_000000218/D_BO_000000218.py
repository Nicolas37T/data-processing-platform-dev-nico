...
class D_BO_000000218(SNIS):
    ...
    def get_data(self, main_url,path, updated_to,format='%Y-%m-%d'):
        ...
        variable={
            "code":"08",
            "key_words":"referencias hospitalarias"
            }
        form_code='304'
...
#     robot = D_BO_000000218()
#     x = robot.get_data(main_url="https://estadisticas.minsalud.gob.bo/Reportes_Dinamicos/Menu_rep_dinamicos.aspx",updated_to="2024-12-21",path=r"\\10.0.0.9\spim\SNIS\Produccion de Servicios 2\08 Referencias y Contrareferencias Hospitalarias")
#     print(x)
...
Executor_D_BO_000000218 = D_BO_000000218
Robot = D_BO_000000218
