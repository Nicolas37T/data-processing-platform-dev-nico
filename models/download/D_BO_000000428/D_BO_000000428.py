...
class D_BO_000000428(Download_Base):

    def get_file_url(self, main_url, updated_to, key_words = "cruz red rodadura",format='%Y-%m-%d'):
        """
...
Executor_D_BO_000000428 = D_BO_000000428
Robot = D_BO_000000428
