...
class D_BO_000000149(Download_Base):

    def get_file_url(self, main_url, updated_to, key_words = "pib variacion acumulada actividad",format='%Y-%m-%d'):
        """
...
Executor_D_BO_000000149 = D_BO_000000149
Robot = D_BO_000000149
