...
class D_BO_000000141(BCB_Boletin_Mensual):

    def get_file_url(self, main_url, updated_to, key_words = "operaciones sector publico",format='%Y-%m-%d'):
        """
...
Executor_D_BO_000000141 = D_BO_000000141
Robot = D_BO_000000141
