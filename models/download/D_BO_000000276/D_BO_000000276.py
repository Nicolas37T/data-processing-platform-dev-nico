...
class D_BO_000000276(Download_Base):

    def get_file_url(self, main_url, updated_to, key_words = "bolivia deflactor implicito",format='%Y-%m-%d'):
        """
...
Executor_D_BO_000000276 = D_BO_000000276
Robot = D_BO_000000276
