...
class D_BO_000000011(ASFI_Agencias_Bolsa):

    def get_file_url(self, main_url, updated_to, key_words = "cartera instrumento",format='%Y-%m-%d'):
        """
...
Executor_D_BO_000000011 = D_BO_000000011
Robot = D_BO_000000011
