...
class D_BO_000000096(BCB_Sector_Monetario):

    def get_file_url(self, main_url, updated_to, key_words = "fuentes y usos",format='%Y-%m-%d'):
        """
...
Executor_D_BO_000000096 = D_BO_000000096
Robot = D_BO_000000096
