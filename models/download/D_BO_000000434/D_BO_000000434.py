...
class D_BO_000000434(Download_Base):

    def verify_download(self, main_url, updated_to, path, key_words = "2.01.12",format='%Y-%m-%d'):
        """
    ...
    def compare_files(self, files_paths, updated_to, format='%Y-%m-%d'):
        ...
        for file in files_paths: 
            ...
            sub_set =  df_new_file[df_new_file.iloc[:, 0]=="DEPARTAMENTO, PROVINCIA Y MUNICIPIO"].values.tolist()
...
Executor_D_BO_000000434 = D_BO_000000434
Robot = D_BO_000000434
