...
class D_BO_000000499(CNDC):

    def get_file_url(self, main_url, updated_to, key_words="dato hidrologico",format='%Y-%m-%d'):
        """
...
#     robot = Executor_D_BO_000000499()
    # x =robot.get_file_url(main_url="https://www.cndc.bo/estadisticas/index.php",updated_to='2024-08-01')
    # print(len(x))
    # print(x)
    # files = [{'download_url': 'https://www.bcb.gob.bo/webdocs/publicacionesbcb/2024/04/10/01.01P.xlsx', 'tmp_path': r"D:\DATAX\data-processing-platform\models\download\D_BO_000000499\dathid_160824.zip"}]
    # y = robot.compare_files(files_paths=files,updated_to="2024-08-09")
    # print(y)


Executor_D_BO_000000499 = D_BO_000000499
Robot = D_BO_000000499
