...
class D_BO_000000256(Download_Base):
    ...
    def get_file_url(self, main_url, updated_to,format='%Y-%m-%d'):
        ...
        try:
            ...
            for year in range(updated_to.year,today.year+1):
                ...
                url = f"https://www.aps.gob.bo/?option=com_ajax&module=apsfilesdisplayer&method=getFiles&format=json&folder=webdocs___UNE___DP___Estadisticas___Operaciones+y+Control___Fondo+de+Ahorro+Previsional___Patrimonio+del+FAP___Inversiones+en+el+FAP___Inversiones+Acumulado___{year}&format=json"
...
Executor_D_BO_000000256 = D_BO_000000256
Robot = D_BO_000000256
