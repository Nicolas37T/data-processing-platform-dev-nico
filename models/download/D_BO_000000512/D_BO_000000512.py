...
class D_BO_000000512(BCB_Boletin_Mensual):

    def get_file_url(self, main_url, updated_to, key_words = "ingreso divisas",format='%Y-%m-%d'):
        """
...
Executor_D_BO_000000512 = D_BO_000000512
Robot = D_BO_000000512
