...
class D_BO_000000412(Download_Base):

    def get_file_url(self, main_url, updated_to, key_words = "linea fija",format='%Y-%m-%d'):
        """
...
Executor_D_BO_000000412 = D_BO_000000412
Robot = D_BO_000000412
