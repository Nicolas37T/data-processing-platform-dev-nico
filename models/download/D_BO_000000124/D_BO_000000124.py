...
class D_BO_000000124(BCB_Boletin_Mensual):

    def get_file_url(self, main_url, updated_to, key_words = "3.01 bancario bancos",format='%Y-%m-%d'):
        """
...
Executor_D_BO_000000124 = D_BO_000000124
Robot = D_BO_000000124
