...
class D_BO_000000093(BCB_Boletin_Mensual):

    def get_file_url(self, main_url, updated_to, key_words = "activos externos",format='%Y-%m-%d'):
        """
...
Executor_D_BO_000000093 = D_BO_000000093
Robot = D_BO_000000093
