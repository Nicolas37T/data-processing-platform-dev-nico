...
class D_BO_000000396(Download_Base):

    def get_file_url(self, main_url, updated_to, key_words = "pando pib constantes",format='%Y-%m-%d'):
        """
...
Executor_D_BO_000000396 = D_BO_000000396
Robot = D_BO_000000396
