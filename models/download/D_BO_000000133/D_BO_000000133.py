...
class D_BO_000000133(BCB_Boletin_Mensual):

    def get_file_url(self, main_url, updated_to, key_words = "plazo fijo monedas",format='%Y-%m-%d'):
        """
...
Executor_D_BO_000000133 = D_BO_000000133
Robot = D_BO_000000133
