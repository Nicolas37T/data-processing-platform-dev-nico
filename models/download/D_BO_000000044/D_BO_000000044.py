...
class D_BO_000000044(Download_Base):

    def get_file_url(self, main_url, updated_to, format='%Y-%m-%d', key_words="indice mes"):
        """
...
if __name__ == "__main__":
    ...
    # print(x)
    y = robot.compare_files(files_paths=[{"tmp_path": r"\\10.0.0.9\spim\INE\IGAE\tmp\2024-07-03_160812download.xlsx"}],updated_to="2023-11-21")
    print(y)

Executor_D_BO_000000044 = D_BO_000000044
Robot = D_BO_000000044
