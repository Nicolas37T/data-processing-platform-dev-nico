...
class D_BO_000000066(CNDC):

    def get_file_url(self, main_url, updated_to,key_words="generacion instan" , format='%Y-%m-%d'):
        """
...
Executor_D_BO_000000066 = D_BO_000000066
Robot = D_BO_000000066
