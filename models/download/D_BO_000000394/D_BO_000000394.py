...
class D_BO_000000394(Download_Base):

    def get_file_url(self, main_url, updated_to, key_words = "potosi pib constantes",format='%Y-%m-%d'):
        """
...
Executor_D_BO_000000394 = D_BO_000000394
Robot = D_BO_000000394
