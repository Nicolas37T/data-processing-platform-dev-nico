...
class D_BO_000000302(ASFI):
    ...
    def get_file_url(self, main_url, updated_to,format='%Y-%m-%d'):
        ...
        files_urls = super().get_file_url_main(main_url=main_url,updated_to=updated_to,SECTION=r"colocaciones",KEY_WORDS=r"bmu.*ranking.*contingente")
        return files_urls
    ...
    def compare_files(self, files_paths, updated_to, format='%Y-%m-%d'):
        ...
        files_dicts = super().compare_files_main(files_paths=files_paths, updated_to=updated_to, RE_DATE=r'((?:enero|febrero|marzo|abril|mayo|junio|julio|agosto|septiembre|octubre|noviembre|diciembre|ene|feb|mar|abr|may|jun|jul|ago|sep|oct|nov|dic))\D*(\d{1,2})',SHEET=-1,TYPE=3)
        return files_dicts
    
if __name__ == "__main__":
    robot = Executor_D_BO_000000302()
...
Executor_D_BO_000000302 = D_BO_000000302
Robot = D_BO_000000302
