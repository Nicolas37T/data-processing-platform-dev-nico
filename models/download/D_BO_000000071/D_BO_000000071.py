...
class D_BO_000000071(CNDC):

    def get_file_url(self, main_url, updated_to,key_words="demanda maxima ~coincidental" , format='%Y-%m-%d'):
        """
...
Executor_D_BO_000000071 = D_BO_000000071
Robot = D_BO_000000071
