...
class D_BO_000000154(Download_Base):

    def get_file_url(self, main_url, updated_to, key_words = "oferta demanda constantes",format='%Y-%m-%d'):
        """
...
Executor_D_BO_000000154 = D_BO_000000154
Robot = D_BO_000000154
