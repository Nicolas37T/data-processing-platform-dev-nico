...
class BCB_Sector_Externo(Download_Base):
    ...
    def get_file_url_main(self, main_url, updated_to, key_words='', format='%Y-%m-%d'):
        ...
        with sync_playwright() as pl:
            ...
            report_xpath = '//details[@class="bcb-ext-acc"]//a[@href]'
            ...
            try:
                ...
                links = [link for link in page.query_selector_all(report_xpath) if search_key_words(text=link.inner_text(),key_word=key_words)]                
