...
class D_BO_000000445(Download_Base):

    def get_file_url(self, main_url, updated_to, key_words = "salida aerea nacionalidad",format='%Y-%m-%d'):
        """
...
Executor_D_BO_000000445 = D_BO_000000445
Robot = D_BO_000000445
