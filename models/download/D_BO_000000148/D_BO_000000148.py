...
class D_BO_000000148(Download_Base):

    def get_file_url(self, main_url, updated_to, key_words = "pib constantes actividad",format='%Y-%m-%d'):
        """
...
Executor_D_BO_000000148 = D_BO_000000148
Robot = D_BO_000000148
