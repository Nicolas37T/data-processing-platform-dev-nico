import re, os, zipfile, traceback
...
class D_BO_000000289(Download_Base):
    ...
    def get_file_url(self, main_url, updated_to,format='%Y-%m-%d'):
        ...
        with sync_playwright() as pl:
            ...
            try:
                ...
                links_filtered = [link.get_attribute('href') for link in page.query_selector_all('//a[@href]') if re.search(r"segunda.*entidad",link.get_attribute('href'),re.IGNORECASE)]
...
#     robot = D_BO_000000289()
#     # x = robot.get_file_url(main_url="https://www.asfi.gob.bo/index.php/banco-de-desarrollo-productivo.html",updated_to="2023-5-21")
#     # print(len(x))
#     # print(x)
#     files = [{'download_url': 'https://www.bcb.gob.bo/webdocs/publicacionesbcb/2024/04/10/01.01P.xlsx', 'tmp_path': r"C:\Users\Kevin Padilla\Downloads\BMU_EstadosFinancierosDesagregados.zip"}]
#     y = robot.compare_files(files_paths=files,updated_to="2023-01-21")
#     print(y)

Executor_D_BO_000000289 = D_BO_000000289
Robot = D_BO_000000289
