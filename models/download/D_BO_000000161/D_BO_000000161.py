...
class D_BO_000000161(Download_Base):

    def get_file_url(self, main_url, updated_to, key_words = "indice telecomunicaciones",format='%Y-%m-%d'):
        """
...
#     robot = D_BO_000000161()
#     x = robot.get_file_url(main_url="https://www.ine.gob.bo/index.php/estadisticas-economicas/hidrocarburos-mineria/mineria-cuadros-estadisticos/",updated_to="2023-10-21")
#     print(len(x))
#     print(x)
...
Executor_D_BO_000000161 = D_BO_000000161
Robot = D_BO_000000161
