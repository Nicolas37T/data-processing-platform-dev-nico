...
class D_BO_000000003(ASFI_Agencias_Bolsa):

    def get_file_url(self, main_url, updated_to, key_words = "er safi",format='%Y-%m-%d'):
        """
...
Executor_D_BO_000000003 = D_BO_000000003
Robot = D_BO_000000003
