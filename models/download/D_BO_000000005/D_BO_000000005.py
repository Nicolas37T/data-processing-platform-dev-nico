...
class D_BO_000000005(ASFI_Agencias_Bolsa):

    def get_file_url(self, main_url, updated_to, key_words = "er bolsa",format='%Y-%m-%d'):
        """
...
Executor_D_BO_000000005 = D_BO_000000005
Robot = D_BO_000000005
