...
class D_BO_000000287(ASFI):
    ...
    def get_file_url(self, main_url, updated_to,format='%Y-%m-%d'):
        ...
        files_urls = super().get_file_url_main(main_url=main_url,updated_to=updated_to,SECTION=r"captaciones",KEY_WORDS=r"encaje.*legal")
        return files_urls
...
Executor_D_BO_000000287 = D_BO_000000287
Robot = D_BO_000000287
