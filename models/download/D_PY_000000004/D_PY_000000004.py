...
class D_PY_000000004(Download_Base):
    ...
    def check_new_data(self, main_url, updated_to,path,key_words, format='%Y-%m-%d'):
        ...
        table_rows_xpath = '//table[@class="table table-striped table-bordered"]//tr'
        ...
        try:            
            with sync_playwright() as pl:
                ...
                while True:
                    ...
                    print([x.inner_text() for x in days_buttons])
                    for day in days_buttons:
                        day.click()                        
                        page.wait_for_timeout(random.randint(2,5)*1000)

                        page.wait_for_selector(table_rows_xpath)
...
Executor_D_PY_000000004 = D_PY_000000004
Robot = D_PY_000000004
